...
; CHECK-NEXT:    v_writelane_b32 v7, s30, 32
; CHECK-NEXT:    v_writelane_b32 v7, s31, 33
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v3, s4, 16
; CHECK-NEXT:    v_writelane_b32 v3, s5, 17
; CHECK-NEXT:    v_writelane_b32 v3, s6, 18
; CHECK-NEXT:    v_writelane_b32 v3, s7, 19
; CHECK-NEXT:    v_writelane_b32 v3, s8, 20
; CHECK-NEXT:    v_writelane_b32 v3, s9, 21
; CHECK-NEXT:    image_sample_lz v5, v[1:2], s[4:11], s[20:23] dmask:0x1
; CHECK-NEXT:    v_writelane_b32 v3, s10, 22
; CHECK-NEXT:    v_writelane_b32 v3, s11, 23
; CHECK-NEXT:    v_writelane_b32 v3, s12, 24
; CHECK-NEXT:    v_writelane_b32 v3, s13, 25
; CHECK-NEXT:    v_writelane_b32 v3, s14, 26
; CHECK-NEXT:    v_writelane_b32 v3, s15, 27
; CHECK-NEXT:    v_writelane_b32 v3, s16, 28
; CHECK-NEXT:    v_writelane_b32 v3, s17, 29
; CHECK-NEXT:    v_writelane_b32 v3, s18, 30
; CHECK-NEXT:    v_writelane_b32 v3, s19, 31
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v3, s4, 32
; CHECK-NEXT:    v_writelane_b32 v3, s5, 33
; CHECK-NEXT:    v_writelane_b32 v3, s6, 34
; CHECK-NEXT:    v_writelane_b32 v3, s7, 35
; CHECK-NEXT:    v_writelane_b32 v3, s8, 36
; CHECK-NEXT:    v_writelane_b32 v3, s9, 37
; CHECK-NEXT:    v_writelane_b32 v3, s10, 38
; CHECK-NEXT:    v_writelane_b32 v3, s11, 39
...
; CHECK-NEXT:    v_readlane_b32 s36, v3, 32
; CHECK-NEXT:    v_readlane_b32 s40, v3, 36
; CHECK-NEXT:    v_readlane_b32 s41, v3, 37
; CHECK-NEXT:    v_readlane_b32 s42, v3, 38
; CHECK-NEXT:    v_readlane_b32 s43, v3, 39
; CHECK-NEXT:    s_mov_b32 s21, s20
; CHECK-NEXT:    s_mov_b32 s22, s20
; CHECK-NEXT:    s_mov_b32 s23, s20
; CHECK-NEXT:    v_readlane_b32 s37, v3, 33
; CHECK-NEXT:    v_readlane_b32 s38, v3, 34
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    image_sample_lz v5, v[1:2], s[60:67], s[40:43] dmask:0x1
; CHECK-NEXT:    v_readlane_b32 s39, v3, 35
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_readlane_b32 s12, v3, 32
; CHECK-NEXT:    v_readlane_b32 s13, v3, 33
; CHECK-NEXT:    v_readlane_b32 s14, v3, 34
; CHECK-NEXT:    v_readlane_b32 s15, v3, 35
; CHECK-NEXT:    v_readlane_b32 s16, v3, 36
; CHECK-NEXT:    v_readlane_b32 s17, v3, 37
; CHECK-NEXT:    v_readlane_b32 s18, v3, 38
; CHECK-NEXT:    v_readlane_b32 s19, v3, 39
; CHECK-NEXT:    v_writelane_b32 v3, s4, 40
; CHECK-NEXT:    v_writelane_b32 v3, s5, 41
; CHECK-NEXT:    v_writelane_b32 v3, s6, 42
; CHECK-NEXT:    v_writelane_b32 v3, s7, 43
; CHECK-NEXT:    v_writelane_b32 v3, s8, 44
; CHECK-NEXT:    v_writelane_b32 v3, s9, 45
; CHECK-NEXT:    v_writelane_b32 v3, s10, 46
; CHECK-NEXT:    v_writelane_b32 v3, s11, 47
; CHECK-NEXT:    v_writelane_b32 v3, s12, 48
; CHECK-NEXT:    v_writelane_b32 v3, s13, 49
; CHECK-NEXT:    v_writelane_b32 v3, s14, 50
; CHECK-NEXT:    v_writelane_b32 v3, s15, 51
; CHECK-NEXT:    v_writelane_b32 v3, s16, 52
; CHECK-NEXT:    v_writelane_b32 v3, s17, 53
; CHECK-NEXT:    v_writelane_b32 v3, s18, 54
; CHECK-NEXT:    v_writelane_b32 v3, s19, 55
; CHECK-NEXT:    ; implicit-def: $vgpr2 : SGPR spill to VGPR lane
; CHECK-NEXT:    v_writelane_b32 v3, s52, 56
; CHECK-NEXT:    v_writelane_b32 v2, s60, 0
; CHECK-NEXT:    v_writelane_b32 v3, s53, 57
; CHECK-NEXT:    v_writelane_b32 v2, s61, 1
; CHECK-NEXT:    v_writelane_b32 v3, s54, 58
; CHECK-NEXT:    v_writelane_b32 v2, s62, 2
; CHECK-NEXT:    v_writelane_b32 v3, s55, 59
; CHECK-NEXT:    v_writelane_b32 v2, s63, 3
; CHECK-NEXT:    v_writelane_b32 v3, s56, 60
; CHECK-NEXT:    v_writelane_b32 v2, s64, 4
; CHECK-NEXT:    v_writelane_b32 v3, s57, 61
; CHECK-NEXT:    v_writelane_b32 v2, s65, 5
; CHECK-NEXT:    v_writelane_b32 v3, s58, 62
; CHECK-NEXT:    v_writelane_b32 v2, s66, 6
; CHECK-NEXT:    v_writelane_b32 v3, s59, 63
; CHECK-NEXT:    v_writelane_b32 v2, s67, 7
...
; CHECK-NEXT:    v_readlane_b32 s52, v3, 40
; CHECK-NEXT:    v_readlane_b32 s53, v3, 41
; CHECK-NEXT:    v_readlane_b32 s54, v3, 42
; CHECK-NEXT:    v_readlane_b32 s55, v3, 43
; CHECK-NEXT:    v_readlane_b32 s56, v3, 44
; CHECK-NEXT:    v_readlane_b32 s57, v3, 45
; CHECK-NEXT:    v_readlane_b32 s58, v3, 46
; CHECK-NEXT:    v_readlane_b32 s59, v3, 47
; CHECK-NEXT:    v_readlane_b32 s60, v3, 48
; CHECK-NEXT:    v_readlane_b32 s61, v3, 49
; CHECK-NEXT:    v_readlane_b32 s62, v3, 50
; CHECK-NEXT:    v_readlane_b32 s63, v3, 51
; CHECK-NEXT:    v_readlane_b32 s64, v3, 52
; CHECK-NEXT:    v_readlane_b32 s65, v3, 53
; CHECK-NEXT:    v_readlane_b32 s66, v3, 54
; CHECK-NEXT:    v_readlane_b32 s67, v3, 55
...
; CHECK-NEXT:    v_readlane_b32 s36, v3, 56
; CHECK-NEXT:    s_mov_b32 s9, s8
; CHECK-NEXT:    s_mov_b32 s10, s8
; CHECK-NEXT:    s_mov_b32 s11, s8
; CHECK-NEXT:    v_mov_b32_e32 v5, s7
; CHECK-NEXT:    v_readlane_b32 s37, v3, 57
; CHECK-NEXT:    v_readlane_b32 s38, v3, 58
; CHECK-NEXT:    v_readlane_b32 s39, v3, 59
; CHECK-NEXT:    v_readlane_b32 s40, v3, 60
; CHECK-NEXT:    v_readlane_b32 s41, v3, 61
; CHECK-NEXT:    v_readlane_b32 s42, v3, 62
; CHECK-NEXT:    v_readlane_b32 s43, v3, 63
; CHECK-NEXT:    v_readlane_b32 s44, v2, 0
; CHECK-NEXT:    v_readlane_b32 s45, v2, 1
; CHECK-NEXT:    v_readlane_b32 s46, v2, 2
; CHECK-NEXT:    v_readlane_b32 s47, v2, 3
; CHECK-NEXT:    v_readlane_b32 s48, v2, 4
; CHECK-NEXT:    v_readlane_b32 s49, v2, 5
; CHECK-NEXT:    v_readlane_b32 s50, v2, 6
; CHECK-NEXT:    v_readlane_b32 s51, v2, 7
; CHECK-NEXT:    image_sample_lz v1, v[4:5], s[36:43], s[8:11] dmask:0x1
; CHECK-NEXT:    image_sample_lz v2, v[4:5], s[52:59], s[8:11] dmask:0x1
...
; CHECK-NEXT:    ; kill: killed $vgpr4_vgpr5
...
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_sub_f32_e32 v1, v2, v1
...
; CHECK-NEXT:    v_readlane_b32 s30, v7, 32
; CHECK-NEXT:    v_readlane_b32 s31, v7, 33
