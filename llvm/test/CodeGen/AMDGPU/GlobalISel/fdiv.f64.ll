...
; GFX6-NEXT:    v_div_scale_f64 v[4:5], vcc, v[2:3], v[2:3], v[0:1]
; GFX6-NEXT:    v_div_scale_f64 v[10:11], vcc, v[0:1], v[2:3], v[0:1]
...
; GFX8-NEXT:    v_div_scale_f64 v[4:5], vcc, v[2:3], v[2:3], v[0:1]
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_div_scale_f64 v[2:3], vcc, v[0:1], v[0:1], 1.0
; GFX6-NEXT:    v_div_scale_f64 v[8:9], vcc, 1.0, v[0:1], 1.0
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_div_scale_f64 v[2:3], vcc, v[0:1], v[0:1], 1.0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_div_scale_f64 v[2:3], vcc, v[0:1], v[0:1], 1.0
...
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    v_div_scale_f64 v[2:3], vcc_lo, v[0:1], v[0:1], 1.0
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_div_scale_f64 v[2:3], vcc_lo, v[0:1], v[0:1], 1.0
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_div_scale_f64 v[8:9], vcc, v[4:5], v[4:5], v[0:1]
; GFX6-NEXT:    v_div_scale_f64 v[14:15], vcc, v[0:1], v[4:5], v[0:1]
; GFX6-NEXT:    v_rcp_f64_e32 v[10:11], v[8:9]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], v5, v9
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v15
; GFX6-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX6-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[10:11], 1.0
; GFX6-NEXT:    v_fma_f64 v[10:11], v[10:11], v[12:13], v[10:11]
; GFX6-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[10:11], 1.0
; GFX6-NEXT:    v_fma_f64 v[10:11], v[10:11], v[12:13], v[10:11]
; GFX6-NEXT:    v_mul_f64 v[12:13], v[14:15], v[10:11]
; GFX6-NEXT:    v_fma_f64 v[14:15], -v[8:9], v[12:13], v[14:15]
; GFX6-NEXT:    v_div_fmas_f64 v[8:9], v[14:15], v[10:11], v[12:13]
; GFX6-NEXT:    v_div_scale_f64 v[10:11], vcc, v[6:7], v[6:7], v[2:3]
; GFX6-NEXT:    v_div_scale_f64 v[16:17], vcc, v[2:3], v[6:7], v[2:3]
; GFX6-NEXT:    v_rcp_f64_e32 v[12:13], v[10:11]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], v7, v11
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v17
; GFX6-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX6-NEXT:    v_fma_f64 v[14:15], -v[10:11], v[12:13], 1.0
; GFX6-NEXT:    v_div_fixup_f64 v[0:1], v[8:9], v[4:5], v[0:1]
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_div_scale_f64 v[8:9], vcc, v[4:5], v[4:5], v[0:1]
; GFX8-NEXT:    v_rcp_f64_e32 v[10:11], v[8:9]
; GFX8-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[10:11], 1.0
; GFX8-NEXT:    v_fma_f64 v[10:11], v[10:11], v[12:13], v[10:11]
; GFX8-NEXT:    v_div_scale_f64 v[12:13], vcc, v[0:1], v[4:5], v[0:1]
; GFX8-NEXT:    v_fma_f64 v[14:15], -v[8:9], v[10:11], 1.0
; GFX8-NEXT:    v_fma_f64 v[10:11], v[10:11], v[14:15], v[10:11]
; GFX8-NEXT:    v_mul_f64 v[14:15], v[12:13], v[10:11]
; GFX8-NEXT:    v_fma_f64 v[8:9], -v[8:9], v[14:15], v[12:13]
; GFX8-NEXT:    v_div_fmas_f64 v[8:9], v[8:9], v[10:11], v[14:15]
; GFX8-NEXT:    v_div_scale_f64 v[10:11], vcc, v[6:7], v[6:7], v[2:3]
; GFX8-NEXT:    v_div_fixup_f64 v[0:1], v[8:9], v[4:5], v[0:1]
; GFX8-NEXT:    v_rcp_f64_e32 v[12:13], v[10:11]
; GFX8-NEXT:    v_fma_f64 v[14:15], -v[10:11], v[12:13], 1.0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_div_scale_f64 v[8:9], vcc, v[4:5], v[4:5], v[0:1]
...
; GFX9-NEXT:    v_div_scale_f64 v[12:13], vcc, v[0:1], v[4:5], v[0:1]
; GFX9-NEXT:    v_fma_f64 v[14:15], -v[8:9], v[10:11], 1.0
...
; GFX9-NEXT:    v_div_scale_f64 v[10:11], vcc, v[6:7], v[6:7], v[2:3]
; GFX9-NEXT:    v_div_fixup_f64 v[0:1], v[8:9], v[4:5], v[0:1]
; GFX9-NEXT:    v_rcp_f64_e32 v[12:13], v[10:11]
; GFX9-NEXT:    v_fma_f64 v[14:15], -v[10:11], v[12:13], 1.0
...
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    v_div_scale_f64 v[8:9], vcc_lo, v[4:5], v[4:5], v[0:1]
; GFX10-NEXT:    v_div_scale_f64 v[14:15], vcc_lo, v[0:1], v[4:5], v[0:1]
...
; GFX10-NEXT:    v_fma_f64 v[8:9], -v[8:9], v[12:13], v[14:15]
; GFX10-NEXT:    v_div_fmas_f64 v[8:9], v[8:9], v[10:11], v[12:13]
; GFX10-NEXT:    v_div_scale_f64 v[10:11], vcc_lo, v[6:7], v[6:7], v[2:3]
; GFX10-NEXT:    v_div_scale_f64 v[16:17], vcc_lo, v[2:3], v[6:7], v[2:3]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_div_scale_f64 v[8:9], vcc_lo, v[4:5], v[4:5], v[0:1]
; GFX11-NEXT:    v_div_scale_f64 v[14:15], vcc_lo, v[0:1], v[4:5], v[0:1]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
...
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[8:9], v[12:13], v[14:15]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_div_fmas_f64 v[8:9], v[8:9], v[10:11], v[12:13]
; GFX11-NEXT:    v_div_scale_f64 v[10:11], vcc_lo, v[6:7], v[6:7], v[2:3]
; GFX11-NEXT:    v_div_scale_f64 v[16:17], vcc_lo, v[2:3], v[6:7], v[2:3]
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_div_scale_f64 v[4:5], vcc, v[0:1], v[0:1], 1.0
; GFX6-NEXT:    v_div_scale_f64 v[10:11], vcc, 1.0, v[0:1], 1.0
; GFX6-NEXT:    v_rcp_f64_e32 v[6:7], v[4:5]
; GFX6-NEXT:    v_mov_b32_e32 v14, 0x3ff00000
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v14, v11
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_div_scale_f64 v[4:5], vcc, v[0:1], v[0:1], 1.0
; GFX8-NEXT:    v_rcp_f64_e32 v[6:7], v[4:5]
; GFX8-NEXT:    v_fma_f64 v[8:9], -v[4:5], v[6:7], 1.0
; GFX8-NEXT:    v_fma_f64 v[6:7], v[6:7], v[8:9], v[6:7]
; GFX8-NEXT:    v_div_scale_f64 v[8:9], vcc, 1.0, v[0:1], 1.0
; GFX8-NEXT:    v_fma_f64 v[10:11], -v[4:5], v[6:7], 1.0
; GFX8-NEXT:    v_fma_f64 v[6:7], v[6:7], v[10:11], v[6:7]
; GFX8-NEXT:    v_mul_f64 v[10:11], v[8:9], v[6:7]
; GFX8-NEXT:    v_fma_f64 v[4:5], -v[4:5], v[10:11], v[8:9]
; GFX8-NEXT:    v_div_fmas_f64 v[4:5], v[4:5], v[6:7], v[10:11]
; GFX8-NEXT:    v_div_scale_f64 v[6:7], vcc, v[2:3], v[2:3], 1.0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_div_scale_f64 v[4:5], vcc, v[0:1], v[0:1], 1.0
; GFX9-NEXT:    v_rcp_f64_e32 v[6:7], v[4:5]
; GFX9-NEXT:    v_fma_f64 v[8:9], -v[4:5], v[6:7], 1.0
; GFX9-NEXT:    v_fma_f64 v[6:7], v[6:7], v[8:9], v[6:7]
; GFX9-NEXT:    v_div_scale_f64 v[8:9], vcc, 1.0, v[0:1], 1.0
; GFX9-NEXT:    v_fma_f64 v[10:11], -v[4:5], v[6:7], 1.0
; GFX9-NEXT:    v_fma_f64 v[6:7], v[6:7], v[10:11], v[6:7]
; GFX9-NEXT:    v_mul_f64 v[10:11], v[8:9], v[6:7]
; GFX9-NEXT:    v_fma_f64 v[4:5], -v[4:5], v[10:11], v[8:9]
; GFX9-NEXT:    v_div_fmas_f64 v[4:5], v[4:5], v[6:7], v[10:11]
; GFX9-NEXT:    v_div_scale_f64 v[6:7], vcc, v[2:3], v[2:3], 1.0
...
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    v_div_scale_f64 v[4:5], vcc_lo, v[0:1], v[0:1], 1.0
; GFX10-NEXT:    v_div_scale_f64 v[10:11], vcc_lo, 1.0, v[0:1], 1.0
; GFX10-NEXT:    v_rcp_f64_e32 v[6:7], v[4:5]
; GFX10-NEXT:    v_fma_f64 v[8:9], -v[4:5], v[6:7], 1.0
; GFX10-NEXT:    v_fma_f64 v[6:7], v[6:7], v[8:9], v[6:7]
; GFX10-NEXT:    v_fma_f64 v[8:9], -v[4:5], v[6:7], 1.0
...
; GFX10-NEXT:    v_fma_f64 v[4:5], -v[4:5], v[8:9], v[10:11]
; GFX10-NEXT:    v_div_fmas_f64 v[4:5], v[4:5], v[6:7], v[8:9]
; GFX10-NEXT:    v_div_scale_f64 v[6:7], vcc_lo, v[2:3], v[2:3], 1.0
; GFX10-NEXT:    v_div_scale_f64 v[12:13], vcc_lo, 1.0, v[2:3], 1.0
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_div_scale_f64 v[4:5], vcc_lo, v[0:1], v[0:1], 1.0
; GFX11-NEXT:    v_div_scale_f64 v[10:11], vcc_lo, 1.0, v[0:1], 1.0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_rcp_f64_e32 v[6:7], v[4:5]
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[4:5], v[6:7], 1.0
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_div_fmas_f64 v[4:5], v[4:5], v[6:7], v[8:9]
; GFX11-NEXT:    v_div_scale_f64 v[6:7], vcc_lo, v[2:3], v[2:3], 1.0
; GFX11-NEXT:    v_div_scale_f64 v[12:13], vcc_lo, 1.0, v[2:3], 1.0
