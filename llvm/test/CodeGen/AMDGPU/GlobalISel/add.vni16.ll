...
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX8-NEXT:    flat_load_ushort v20, v[10:11]
; GFX8-NEXT:    flat_load_ushort v21, v[12:13]
; GFX8-NEXT:    flat_load_ushort v22, v[0:1]
; GFX8-NEXT:    flat_load_dwordx4 v[10:13], v[2:3]
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, 16, v2
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v3, vcc
...
; GFX8-NEXT:    v_add_u32_e32 v18, vcc, 20, v4
; GFX8-NEXT:    v_addc_u32_e32 v19, vcc, 0, v5, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(3)
...
; GFX8-NEXT:    v_add_u16_sdwa v9, v9, v13 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    s_waitcnt vmcnt(2)
; GFX8-NEXT:    v_add_u16_e32 v13, v20, v0
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_add_u16_e32 v20, v21, v1
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u16_e32 v21, v22, v2
; GFX8-NEXT:    v_or_b32_e32 v0, v3, v6
; GFX8-NEXT:    v_or_b32_e32 v1, v10, v7
; GFX8-NEXT:    v_or_b32_e32 v2, v11, v8
; GFX8-NEXT:    v_or_b32_e32 v3, v12, v9
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    flat_store_short v[14:15], v13
; GFX8-NEXT:    flat_store_short v[16:17], v20
; GFX8-NEXT:    flat_store_short v[18:19], v21
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
