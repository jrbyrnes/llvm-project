...
; GFX7-NEXT:    buffer_store_dword v26, off, s[0:3], s32 ; 4-byte Folded Spill
; GFX7-NEXT:    s_mov_b64 exec, s[4:5]
; GFX7-NEXT:    v_writelane_b32 v26, s34, 0
; GFX7-NEXT:    v_writelane_b32 v26, s35, 1
; GFX7-NEXT:    v_writelane_b32 v26, s30, 2
; GFX7-NEXT:    v_writelane_b32 v26, s31, 3
...
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[28:29], v1, v11, v[18:19]
...
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v3, v9, v[18:19]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[6:7], v5, v9, v[16:17]
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[6:7], v4, v8, v[18:19]
; GFX7-NEXT:    v_mad_u64_u32 v[20:21], s[8:9], v6, v8, v[16:17]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[8:9], v0, v10, 0
; GFX7-NEXT:    v_mad_u64_u32 v[19:20], s[8:9], v0, v13, v[19:20]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[30:31], v1, v9, v[16:17]
; GFX7-NEXT:    v_mad_u64_u32 v[19:20], s[12:13], v1, v12, v[19:20]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v2, v8, v[16:17]
; GFX7-NEXT:    v_mad_u64_u32 v[19:20], s[14:15], v2, v11, v[19:20]
; GFX7-NEXT:    v_mov_b32_e32 v23, v16
; GFX7-NEXT:    v_mov_b32_e32 v16, v17
; GFX7-NEXT:    v_mov_b32_e32 v17, v18
; GFX7-NEXT:    v_mad_u64_u32 v[24:25], s[34:35], v0, v11, v[16:17]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[20:21], v0, v8, 0
; GFX7-NEXT:    v_mad_u64_u32 v[24:25], s[20:21], v1, v10, v[24:25]
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[16:17], v3, v10, v[19:20]
; GFX7-NEXT:    v_mov_b32_e32 v22, v17
; GFX7-NEXT:    v_mad_u64_u32 v[24:25], s[22:23], v2, v9, v[24:25]
; GFX7-NEXT:    v_mad_u64_u32 v[22:23], s[26:27], v0, v9, v[22:23]
; GFX7-NEXT:    v_mul_lo_u32 v20, v4, v11
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[18:19], v4, v9, v[18:19]
; GFX7-NEXT:    v_mul_lo_u32 v17, v6, v9
; GFX7-NEXT:    v_mul_lo_u32 v9, v2, v13
; GFX7-NEXT:    v_mul_lo_u32 v13, v3, v12
; GFX7-NEXT:    v_mad_u64_u32 v[3:4], s[24:25], v3, v8, v[24:25]
; GFX7-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[26:27]
; GFX7-NEXT:    v_mad_u64_u32 v[11:12], s[26:27], v1, v8, v[22:23]
; GFX7-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[28:29]
; GFX7-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX7-NEXT:    v_addc_u32_e64 v1, vcc, 0, v1, s[4:5]
; GFX7-NEXT:    v_addc_u32_e64 v3, s[26:27], v2, v3, s[26:27]
; GFX7-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[30:31]
; GFX7-NEXT:    v_addc_u32_e64 v22, vcc, 0, v1, s[6:7]
; GFX7-NEXT:    v_addc_u32_e64 v6, s[10:11], 0, v2, s[10:11]
; GFX7-NEXT:    v_mul_lo_u32 v10, v5, v10
; GFX7-NEXT:    v_mad_u64_u32 v[1:2], vcc, v5, v8, v[18:19]
; GFX7-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[34:35]
; GFX7-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v5, s[20:21]
; GFX7-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v5, s[22:23]
; GFX7-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v5, s[24:25]
; GFX7-NEXT:    v_mul_lo_u32 v0, v0, v15
; GFX7-NEXT:    v_addc_u32_e64 v4, s[4:5], v6, v4, s[26:27]
; GFX7-NEXT:    v_addc_u32_e64 v5, s[4:5], v5, v1, s[4:5]
; GFX7-NEXT:    v_addc_u32_e64 v6, s[4:5], v22, v2, s[4:5]
; GFX7-NEXT:    v_addc_u32_e64 v0, s[4:5], v21, v0, s[4:5]
; GFX7-NEXT:    v_addc_u32_e32 v0, vcc, v0, v14, vcc
; GFX7-NEXT:    v_addc_u32_e64 v0, vcc, v0, v9, s[18:19]
; GFX7-NEXT:    v_addc_u32_e64 v0, vcc, v0, v13, s[16:17]
; GFX7-NEXT:    v_addc_u32_e64 v0, vcc, v0, v20, s[14:15]
; GFX7-NEXT:    v_addc_u32_e64 v0, vcc, v0, v10, s[12:13]
; GFX7-NEXT:    v_addc_u32_e64 v0, vcc, v0, v17, s[8:9]
; GFX7-NEXT:    v_readlane_b32 s30, v26, 2
...
; GFX7-NEXT:    v_readlane_b32 s31, v26, 3
; GFX7-NEXT:    v_readlane_b32 s35, v26, 1
; GFX7-NEXT:    v_readlane_b32 s34, v26, 0
; GFX7-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; GFX7-NEXT:    buffer_load_dword v26, off, s[0:3], s32 ; 4-byte Folded Reload
; GFX7-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX8-NEXT:    buffer_store_dword v26, off, s[0:3], s32 ; 4-byte Folded Spill
; GFX8-NEXT:    s_mov_b64 exec, s[4:5]
; GFX8-NEXT:    v_writelane_b32 v26, s34, 0
; GFX8-NEXT:    v_writelane_b32 v26, s35, 1
; GFX8-NEXT:    v_writelane_b32 v26, s30, 2
; GFX8-NEXT:    v_writelane_b32 v26, s31, 3
...
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[28:29], v1, v11, v[18:19]
...
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v3, v9, v[18:19]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[6:7], v5, v9, v[16:17]
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[6:7], v4, v8, v[18:19]
; GFX8-NEXT:    v_mad_u64_u32 v[20:21], s[8:9], v6, v8, v[16:17]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[8:9], v0, v10, 0
; GFX8-NEXT:    v_mad_u64_u32 v[19:20], s[8:9], v0, v13, v[19:20]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[30:31], v1, v9, v[16:17]
; GFX8-NEXT:    v_mad_u64_u32 v[19:20], s[12:13], v1, v12, v[19:20]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v2, v8, v[16:17]
; GFX8-NEXT:    v_mad_u64_u32 v[19:20], s[14:15], v2, v11, v[19:20]
; GFX8-NEXT:    v_mov_b32_e32 v23, v16
; GFX8-NEXT:    v_mov_b32_e32 v16, v17
; GFX8-NEXT:    v_mov_b32_e32 v17, v18
; GFX8-NEXT:    v_mad_u64_u32 v[24:25], s[34:35], v0, v11, v[16:17]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[20:21], v0, v8, 0
; GFX8-NEXT:    v_mad_u64_u32 v[24:25], s[20:21], v1, v10, v[24:25]
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[16:17], v3, v10, v[19:20]
; GFX8-NEXT:    v_mov_b32_e32 v22, v17
; GFX8-NEXT:    v_mad_u64_u32 v[24:25], s[22:23], v2, v9, v[24:25]
; GFX8-NEXT:    v_mad_u64_u32 v[22:23], s[26:27], v0, v9, v[22:23]
; GFX8-NEXT:    v_mul_lo_u32 v20, v4, v11
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[18:19], v4, v9, v[18:19]
; GFX8-NEXT:    v_mul_lo_u32 v17, v6, v9
; GFX8-NEXT:    v_mul_lo_u32 v9, v2, v13
; GFX8-NEXT:    v_mul_lo_u32 v13, v3, v12
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[24:25], v3, v8, v[24:25]
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[26:27]
; GFX8-NEXT:    v_mad_u64_u32 v[11:12], s[26:27], v1, v8, v[22:23]
; GFX8-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[28:29]
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX8-NEXT:    v_addc_u32_e64 v1, vcc, 0, v1, s[4:5]
; GFX8-NEXT:    v_addc_u32_e64 v3, s[26:27], v2, v3, s[26:27]
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[30:31]
; GFX8-NEXT:    v_addc_u32_e64 v22, vcc, 0, v1, s[6:7]
; GFX8-NEXT:    v_addc_u32_e64 v6, s[10:11], 0, v2, s[10:11]
; GFX8-NEXT:    v_mul_lo_u32 v10, v5, v10
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], vcc, v5, v8, v[18:19]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[34:35]
; GFX8-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v5, s[20:21]
; GFX8-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v5, s[22:23]
; GFX8-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v5, s[24:25]
; GFX8-NEXT:    v_mul_lo_u32 v0, v0, v15
; GFX8-NEXT:    v_addc_u32_e64 v4, s[4:5], v6, v4, s[26:27]
; GFX8-NEXT:    v_addc_u32_e64 v5, s[4:5], v5, v1, s[4:5]
; GFX8-NEXT:    v_addc_u32_e64 v6, s[4:5], v22, v2, s[4:5]
; GFX8-NEXT:    v_addc_u32_e64 v0, s[4:5], v21, v0, s[4:5]
; GFX8-NEXT:    v_addc_u32_e32 v0, vcc, v0, v14, vcc
; GFX8-NEXT:    v_addc_u32_e64 v0, vcc, v0, v9, s[18:19]
; GFX8-NEXT:    v_addc_u32_e64 v0, vcc, v0, v13, s[16:17]
; GFX8-NEXT:    v_addc_u32_e64 v0, vcc, v0, v20, s[14:15]
; GFX8-NEXT:    v_addc_u32_e64 v0, vcc, v0, v10, s[12:13]
; GFX8-NEXT:    v_addc_u32_e64 v0, vcc, v0, v17, s[8:9]
; GFX8-NEXT:    v_readlane_b32 s30, v26, 2
...
; GFX8-NEXT:    v_readlane_b32 s31, v26, 3
; GFX8-NEXT:    v_readlane_b32 s35, v26, 1
; GFX8-NEXT:    v_readlane_b32 s34, v26, 0
; GFX8-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; GFX8-NEXT:    buffer_load_dword v26, off, s[0:3], s32 ; 4-byte Folded Reload
; GFX8-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX9-NEXT:    buffer_store_dword v26, off, s[0:3], s32 ; 4-byte Folded Spill
; GFX9-NEXT:    s_mov_b64 exec, s[4:5]
; GFX9-NEXT:    v_writelane_b32 v26, s34, 0
; GFX9-NEXT:    v_writelane_b32 v26, s35, 1
; GFX9-NEXT:    v_writelane_b32 v26, s30, 2
; GFX9-NEXT:    v_writelane_b32 v26, s31, 3
...
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[28:29], v1, v11, v[18:19]
...
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v3, v9, v[18:19]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[6:7], v5, v9, v[16:17]
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[6:7], v4, v8, v[18:19]
; GFX9-NEXT:    v_mad_u64_u32 v[20:21], s[8:9], v6, v8, v[16:17]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[8:9], v0, v10, 0
; GFX9-NEXT:    v_mad_u64_u32 v[19:20], s[8:9], v0, v13, v[19:20]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[30:31], v1, v9, v[16:17]
; GFX9-NEXT:    v_mad_u64_u32 v[19:20], s[12:13], v1, v12, v[19:20]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v2, v8, v[16:17]
; GFX9-NEXT:    v_mad_u64_u32 v[19:20], s[14:15], v2, v11, v[19:20]
; GFX9-NEXT:    v_mov_b32_e32 v23, v16
; GFX9-NEXT:    v_mov_b32_e32 v16, v17
; GFX9-NEXT:    v_mov_b32_e32 v17, v18
; GFX9-NEXT:    v_mad_u64_u32 v[24:25], s[34:35], v0, v11, v[16:17]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[20:21], v0, v8, 0
; GFX9-NEXT:    v_mad_u64_u32 v[24:25], s[20:21], v1, v10, v[24:25]
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[16:17], v3, v10, v[19:20]
; GFX9-NEXT:    v_mov_b32_e32 v22, v17
; GFX9-NEXT:    v_mad_u64_u32 v[24:25], s[22:23], v2, v9, v[24:25]
; GFX9-NEXT:    v_mad_u64_u32 v[22:23], s[26:27], v0, v9, v[22:23]
; GFX9-NEXT:    v_mul_lo_u32 v20, v4, v11
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[18:19], v4, v9, v[18:19]
; GFX9-NEXT:    v_mul_lo_u32 v17, v6, v9
; GFX9-NEXT:    v_mul_lo_u32 v9, v2, v13
; GFX9-NEXT:    v_mul_lo_u32 v13, v3, v12
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[24:25], v3, v8, v[24:25]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[26:27]
; GFX9-NEXT:    v_mad_u64_u32 v[11:12], s[26:27], v1, v8, v[22:23]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[28:29]
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v1, vcc, 0, v1, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e64 v3, s[26:27], v2, v3, s[26:27]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[30:31]
; GFX9-NEXT:    v_addc_co_u32_e64 v22, vcc, 0, v1, s[6:7]
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[10:11], 0, v2, s[10:11]
; GFX9-NEXT:    v_mul_lo_u32 v10, v5, v10
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], vcc, v5, v8, v[18:19]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[34:35]
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[4:5], 0, v5, s[20:21]
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[4:5], 0, v5, s[22:23]
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[4:5], 0, v5, s[24:25]
; GFX9-NEXT:    v_mul_lo_u32 v0, v0, v15
; GFX9-NEXT:    v_addc_co_u32_e64 v4, s[4:5], v6, v4, s[26:27]
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[4:5], v5, v1, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[4:5], v22, v2, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[4:5], v21, v0, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v0, v14, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v0, vcc, v0, v9, s[18:19]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, vcc, v0, v13, s[16:17]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, vcc, v0, v20, s[14:15]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, vcc, v0, v10, s[12:13]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, vcc, v0, v17, s[8:9]
; GFX9-NEXT:    v_readlane_b32 s30, v26, 2
...
; GFX9-NEXT:    v_readlane_b32 s31, v26, 3
; GFX9-NEXT:    v_readlane_b32 s35, v26, 1
; GFX9-NEXT:    v_readlane_b32 s34, v26, 0
; GFX9-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; GFX9-NEXT:    buffer_load_dword v26, off, s[0:3], s32 ; 4-byte Folded Reload
; GFX9-NEXT:    s_mov_b64 exec, s[4:5]
