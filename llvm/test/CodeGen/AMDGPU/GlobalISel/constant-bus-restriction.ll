...
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefix=GFX10PLUS %s
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefix=GFX10PLUS %s
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_mov_b32_e32 v0, s3
; GFX9-NEXT:    v_div_scale_f32 v0, vcc, s2, v0, s2
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: div_scale_s_s_true:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_div_scale_f32 v0, vcc_lo, s2, s3, s2
; GFX10PLUS-NEXT:    ; return to shader part epilog
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_mov_b32_e32 v0, s3
; GFX9-NEXT:    v_div_scale_f32 v0, vcc, v0, v0, s2
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: div_scale_s_s_false:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_div_scale_f32 v0, vcc_lo, s3, s3, s2
; GFX10PLUS-NEXT:    ; return to shader part epilog
