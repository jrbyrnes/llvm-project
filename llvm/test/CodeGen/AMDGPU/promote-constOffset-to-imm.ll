...
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, 0xffffb000, v2
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 0xffffb800, v2
; GFX8-NEXT:    s_mov_b64 s[2:3], vcc
; GFX8-NEXT:    v_addc_u32_e64 v8, vcc, -1, v3, s[0:1]
; GFX8-NEXT:    flat_load_dwordx2 v[7:8], v[7:8]
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 0xffffc000, v2
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_addc_u32_e64 v10, vcc, -1, v3, s[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[9:10], v[9:10]
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, 0xffffc800, v2
; GFX8-NEXT:    s_mov_b64 s[2:3], vcc
; GFX8-NEXT:    v_addc_u32_e64 v12, vcc, -1, v3, s[0:1]
; GFX8-NEXT:    flat_load_dwordx2 v[11:12], v[11:12]
; GFX8-NEXT:    v_add_u32_e32 v15, vcc, 0xffffd000, v2
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_addc_u32_e64 v14, vcc, -1, v3, s[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[13:14], v[13:14]
; GFX8-NEXT:    v_add_u32_e32 v17, vcc, 0xffffd800, v2
; GFX8-NEXT:    s_mov_b64 s[2:3], vcc
; GFX8-NEXT:    v_addc_u32_e64 v16, vcc, -1, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e32 v19, vcc, 0xffffe000, v2
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_addc_u32_e64 v18, vcc, -1, v3, s[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[15:16], v[15:16]
; GFX8-NEXT:    v_add_u32_e32 v21, vcc, 0xffffe800, v2
; GFX8-NEXT:    s_mov_b64 s[2:3], vcc
; GFX8-NEXT:    flat_load_dwordx2 v[17:18], v[17:18]
; GFX8-NEXT:    v_addc_u32_e64 v20, s[0:1], -1, v3, s[0:1]
; GFX8-NEXT:    v_addc_u32_e64 v22, s[2:3], -1, v3, s[2:3]
; GFX8-NEXT:    s_addk_i32 s5, 0x2000
; GFX8-NEXT:    s_cmp_gt_u32 s5, 0x3fffff
; GFX8-NEXT:    s_waitcnt vmcnt(5)
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v4
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, v8, v5, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, 0xfffff000, v2
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    s_waitcnt vmcnt(4)
; GFX8-NEXT:    v_add_u32_e32 v23, vcc, v9, v7
; GFX8-NEXT:    flat_load_dwordx2 v[7:8], v[19:20]
; GFX8-NEXT:    flat_load_dwordx2 v[19:20], v[21:22]
; GFX8-NEXT:    v_addc_u32_e32 v10, vcc, v10, v5, vcc
; GFX8-NEXT:    v_addc_u32_e64 v5, s[0:1], -1, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 0xfffff800, v2
; GFX8-NEXT:    s_waitcnt vmcnt(5)
; GFX8-NEXT:    v_add_u32_e64 v11, s[2:3], v11, v23
; GFX8-NEXT:    flat_load_dwordx2 v[4:5], v[4:5]
; GFX8-NEXT:    v_addc_u32_e64 v12, s[0:1], v12, v10, s[2:3]
; GFX8-NEXT:    v_addc_u32_e32 v10, vcc, -1, v3, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[9:10], v[9:10]
; GFX8-NEXT:    s_waitcnt vmcnt(6)
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, v13, v11
; GFX8-NEXT:    v_addc_u32_e32 v14, vcc, v14, v12, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[11:12], v[2:3]
...
; GFX8-NEXT:    v_addc_u32_e32 v8, vcc, v8, v14, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(3)
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v19, v7
; GFX8-NEXT:    v_addc_u32_e32 v8, vcc, v20, v8, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(2)
...
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, v10, v5, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v11, v4
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, v12, v5, vcc
...
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX900-NEXT:    s_movk_i32 s6, 0x7f
; GFX900-NEXT:    v_mov_b32_e32 v5, 0
; GFX900-NEXT:    s_movk_i32 s4, 0xd000
; GFX900-NEXT:    s_movk_i32 s5, 0xe000
; GFX900-NEXT:    s_movk_i32 s7, 0xf000
...
; GFX900-NEXT:    s_mov_b64 s[2:3], vcc
; GFX900-NEXT:    v_addc_co_u32_e64 v8, vcc, -1, v3, s[0:1]
...
; GFX900-NEXT:    v_add_co_u32_e32 v15, vcc, s4, v2
; GFX900-NEXT:    global_load_dwordx2 v[7:8], v[7:8], off
; GFX900-NEXT:    s_mov_b64 s[0:1], vcc
; GFX900-NEXT:    v_addc_co_u32_e64 v14, vcc, -1, v3, s[2:3]
; GFX900-NEXT:    global_load_dwordx2 v[19:20], v[13:14], off offset:-2048
; GFX900-NEXT:    global_load_dwordx2 v[21:22], v[13:14], off
; GFX900-NEXT:    v_add_co_u32_e32 v17, vcc, s5, v2
; GFX900-NEXT:    s_mov_b64 s[2:3], vcc
; GFX900-NEXT:    v_addc_co_u32_e64 v16, vcc, -1, v3, s[0:1]
; GFX900-NEXT:    global_load_dwordx2 v[15:16], v[15:16], off offset:-2048
; GFX900-NEXT:    v_addc_co_u32_e64 v18, s[2:3], -1, v3, s[2:3]
; GFX900-NEXT:    v_add_co_u32_e32 v13, vcc, s7, v2
; GFX900-NEXT:    s_addk_i32 s8, 0x2000
; GFX900-NEXT:    s_cmp_gt_u32 s8, 0x3fffff
; GFX900-NEXT:    s_waitcnt vmcnt(3)
; GFX900-NEXT:    v_add_co_u32_e64 v4, s[0:1], v7, v4
; GFX900-NEXT:    v_addc_co_u32_e64 v7, s[0:1], v8, v5, s[0:1]
; GFX900-NEXT:    s_waitcnt vmcnt(2)
; GFX900-NEXT:    v_add_co_u32_e64 v8, s[0:1], v19, v4
; GFX900-NEXT:    global_load_dwordx2 v[4:5], v[17:18], off offset:-4096
; GFX900-NEXT:    v_addc_co_u32_e64 v14, s[0:1], v20, v7, s[0:1]
; GFX900-NEXT:    s_waitcnt vmcnt(2)
; GFX900-NEXT:    v_add_co_u32_e64 v21, s[0:1], v21, v8
; GFX900-NEXT:    global_load_dwordx2 v[7:8], v[17:18], off offset:-2048
; GFX900-NEXT:    global_load_dwordx2 v[19:20], v[17:18], off
; GFX900-NEXT:    v_addc_co_u32_e64 v17, s[0:1], v22, v14, s[0:1]
; GFX900-NEXT:    v_addc_co_u32_e32 v14, vcc, -1, v3, vcc
; GFX900-NEXT:    global_load_dwordx2 v[13:14], v[13:14], off offset:-2048
; GFX900-NEXT:    s_waitcnt vmcnt(4)
; GFX900-NEXT:    v_add_co_u32_e32 v18, vcc, v15, v21
; GFX900-NEXT:    v_addc_co_u32_e32 v17, vcc, v16, v17, vcc
; GFX900-NEXT:    global_load_dwordx2 v[15:16], v[2:3], off
; GFX900-NEXT:    v_add_co_u32_e32 v2, vcc, 0x10000, v2
; GFX900-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v3, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(4)
; GFX900-NEXT:    v_add_co_u32_e32 v4, vcc, v4, v18
; GFX900-NEXT:    v_addc_co_u32_e32 v5, vcc, v5, v17, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(3)
; GFX900-NEXT:    v_add_co_u32_e32 v4, vcc, v7, v4
; GFX900-NEXT:    v_addc_co_u32_e32 v5, vcc, v8, v5, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(2)
; GFX900-NEXT:    v_add_co_u32_e32 v4, vcc, v19, v4
; GFX900-NEXT:    v_addc_co_u32_e32 v5, vcc, v20, v5, vcc
