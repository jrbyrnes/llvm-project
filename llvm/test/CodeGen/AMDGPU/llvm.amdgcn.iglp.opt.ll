...
; GCN-NEXT:    v_add_u32_e32 v2, 0x6000, v0
...
; GCN-NEXT:    ds_read_b128 a[60:63], v0 offset:112
; GCN-NEXT:    ds_read_b128 a[56:59], v0 offset:96
; GCN-NEXT:    ds_read_b128 a[52:55], v0 offset:80
; GCN-NEXT:    ds_read_b128 a[48:51], v0 offset:64
; GCN-NEXT:    ds_read_b128 a[32:35], v0
; GCN-NEXT:    ds_read_b128 a[36:39], v0 offset:16
; GCN-NEXT:    ds_read_b128 a[40:43], v0 offset:32
; GCN-NEXT:    ds_read_b128 a[44:47], v0 offset:48
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v2, v3, a[32:63]
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 2
; GCN-NEXT:    ds_write_b128 v1, a[60:63] offset:112
; GCN-NEXT:    ds_write_b128 v1, a[56:59] offset:96
; GCN-NEXT:    ds_read_b128 a[60:63], v0 offset:8304
; GCN-NEXT:    ds_write_b128 v1, a[52:55] offset:80
; GCN-NEXT:    ds_read_b128 a[56:59], v0 offset:8288
; GCN-NEXT:    ds_write_b128 v1, a[48:51] offset:64
; GCN-NEXT:    ds_read_b128 a[52:55], v0 offset:8272
; GCN-NEXT:    ds_write_b128 v1, a[44:47] offset:48
; GCN-NEXT:    ds_read_b128 a[48:51], v0 offset:8256
; GCN-NEXT:    ds_write_b128 v1, a[40:43] offset:32
; GCN-NEXT:    ds_read_b128 a[44:47], v0 offset:8240
; GCN-NEXT:    ds_write_b128 v1, a[36:39] offset:16
; GCN-NEXT:    ds_read_b128 a[40:43], v0 offset:8224
; GCN-NEXT:    ds_write_b128 v1, a[32:35]
; GCN-NEXT:    ds_read_b128 a[36:39], v0 offset:8208
; GCN-NEXT:    ds_read_b128 a[32:35], v0 offset:8192
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v2, v3, a[32:63]
...
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    ds_write_b128 v1, a[56:59] offset:8288
; GCN-NEXT:    ds_write_b128 v1, a[60:63] offset:8304
; GCN-NEXT:    ds_read_b128 a[60:63], v0 offset:24688
; GCN-NEXT:    ds_write_b128 v1, a[48:51] offset:8256
; GCN-NEXT:    ds_read_b128 a[56:59], v0 offset:24672
; GCN-NEXT:    ds_write_b128 v1, a[52:55] offset:8272
; GCN-NEXT:    ds_read_b128 a[52:55], v0 offset:24656
; GCN-NEXT:    ds_write_b128 v1, a[40:43] offset:8224
; GCN-NEXT:    ds_read_b128 a[48:51], v0 offset:24640
; GCN-NEXT:    ds_write_b128 v1, a[44:47] offset:8240
; GCN-NEXT:    ds_read_b128 a[44:47], v0 offset:24624
; GCN-NEXT:    ds_write_b128 v1, a[32:35] offset:8192
; GCN-NEXT:    ds_read_b128 a[40:43], v0 offset:24608
; GCN-NEXT:    ds_write_b128 v1, a[36:39] offset:8208
; GCN-NEXT:    ds_read_b128 a[36:39], v0 offset:24592
; GCN-NEXT:    ds_read_b128 a[32:35], v0 offset:24576
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v2, v3, a[32:63]
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 2
; GCN-NEXT:    ds_write_b128 v1, a[56:59] offset:16480
; GCN-NEXT:    ds_write_b128 v1, a[60:63] offset:16496
; GCN-NEXT:    ds_read_b128 a[60:63], v0 offset:49264
; GCN-NEXT:    ds_write_b128 v1, a[48:51] offset:16448
; GCN-NEXT:    ds_read_b128 a[56:59], v0 offset:49248
; GCN-NEXT:    ds_write_b128 v1, a[52:55] offset:16464
; GCN-NEXT:    ds_read_b128 a[52:55], v0 offset:49232
; GCN-NEXT:    ds_write_b128 v1, a[40:43] offset:16416
; GCN-NEXT:    ds_read_b128 a[48:51], v0 offset:49216
; GCN-NEXT:    ds_write_b128 v1, a[44:47] offset:16432
; GCN-NEXT:    ds_read_b128 a[44:47], v0 offset:49200
; GCN-NEXT:    ds_write_b128 v1, a[32:35] offset:16384
; GCN-NEXT:    ds_read_b128 a[40:43], v0 offset:49184
; GCN-NEXT:    ds_write_b128 v1, a[36:39] offset:16400
; GCN-NEXT:    ds_read_b128 a[36:39], v0 offset:49168
; GCN-NEXT:    ds_read_b128 a[32:35], v0 offset:49152
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v2, v3, a[32:63]
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 2
; GCN-NEXT:    ds_write_b128 v1, a[56:59] offset:24672
; GCN-NEXT:    ds_write_b128 v1, a[60:63] offset:24688
; GCN-NEXT:    ds_write_b128 v1, a[48:51] offset:24640
; GCN-NEXT:    ds_write_b128 v1, a[52:55] offset:24656
; GCN-NEXT:    ds_write_b128 v1, a[40:43] offset:24608
; GCN-NEXT:    ds_write_b128 v1, a[44:47] offset:24624
; GCN-NEXT:    ds_write_b128 v1, a[32:35] offset:24576
; GCN-NEXT:    ds_write_b128 v1, a[36:39] offset:24592
; GCN-NEXT:    s_endpgm
entry:
