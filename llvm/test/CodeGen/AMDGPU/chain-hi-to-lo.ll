...
; GFX900-NEXT:    s_mov_b32 s4, 0x7060100
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
...
; FLATSCR-NEXT:    s_mov_b32 s0, 0x7060100
; FLATSCR-NEXT:    s_waitcnt lgkmcnt(0)
; FLATSCR-NEXT:    v_pk_sub_u16 v0, v0, -12 op_sel_hi:[1,0]
; FLATSCR-NEXT:    v_perm_b32 v0, v0, v1, s0
; FLATSCR-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    v_perm_b32 v0, v0, v1, 0x7060100
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; FLATSCR-NEXT:    s_mov_b32 s0, 0x7060100
; FLATSCR-NEXT:    v_pk_sub_u16 v0, v0, -12 op_sel_hi:[1,0]
; FLATSCR-NEXT:    v_perm_b32 v0, v0, v2, s0
; FLATSCR-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_pk_sub_u16 v0, v0, -12 op_sel_hi:[1,0]
; GFX10-NEXT:    v_perm_b32 v0, v0, v2, 0x7060100
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    v_pk_sub_u16 v0, v0, -12 op_sel_hi:[1,0]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_perm_b32 v0, v0, v2, 0x7060100
; GFX11-NEXT:    s_setpc_b64 s[30:31]
bb:
