...
; GCN-NEXT:    v_mov_b32_e32 v17, s43
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_mov_b32_e32 v15, s35
...
; GCN-NEXT:    v_or_b32_e32 v19, v15, v19
; GCN-NEXT:    v_mov_b32_e32 v15, 15
; GCN-NEXT:    v_lshlrev_b16_e32 v18, 12, v18
; GCN-NEXT:    v_and_b32_sdwa v19, v19, v15 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GCN-NEXT:    v_or_b32_e32 v18, v18, v19
; GCN-NEXT:    s_cmpk_lg_i32 s0, 0x6f
; GCN-NEXT:    v_or_b32_sdwa v17, v17, v18 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
...
; GCN-NEXT:    v_lshlrev_b16_e32 v18, 12, v18
; GCN-NEXT:    v_and_b32_sdwa v16, v16, v15 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GCN-NEXT:    v_or_b32_sdwa v3, v3, v16 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NEXT:    v_mov_b32_e32 v16, s34
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmpk_lg_i32 s0, 0x56
; GCN-NEXT:    v_or_b32_sdwa v3, v3, v17 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GCN-NEXT:    v_cndmask_b32_e32 v16, 1, v16, vcc
...
; GCN-NEXT:    v_mov_b32_e32 v20, s25
; GCN-NEXT:    v_lshlrev_b16_e32 v18, 3, v18
; GCN-NEXT:    v_lshlrev_b16_e32 v19, 2, v19
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_and_b32_sdwa v18, v18, v15 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GCN-NEXT:    v_or_b32_e32 v17, v17, v18
; GCN-NEXT:    s_cmpk_lg_i32 s0, 0x4f
; GCN-NEXT:    v_or_b32_sdwa v16, v16, v17 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NEXT:    v_lshrrev_b16_e64 v17, 15, s6
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_e32 v17, v17, v18
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 7, s6
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_e32 v18, v19, v18
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 3, s6
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_e32 v16, v16, v17
; GCN-NEXT:    v_mov_b32_e32 v17, s22
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_e32 v16, v17, v16
; GCN-NEXT:    v_mov_b32_e32 v17, s20
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 50
; GCN-NEXT:    v_cndmask_b32_e32 v17, 1, v17, vcc
; GCN-NEXT:    v_mov_b32_e32 v18, s19
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    v_and_b32_e32 v18, 1, v18
; GCN-NEXT:    v_lshlrev_b16_e32 v17, 3, v17
...
; GCN-NEXT:    v_or_b32_e32 v16, v17, v16
; GCN-NEXT:    v_lshrrev_b16_e64 v17, 7, s16
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 62
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 6, s16
; GCN-NEXT:    v_cndmask_b32_e32 v17, 1, v17, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    v_and_b32_e32 v18, 1, v18
...
; GCN-NEXT:    v_or_b32_e32 v17, v17, v18
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 5, s16
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 60
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 4, s16
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    v_lshlrev_b16_e32 v18, 1, v18
...
; GCN-NEXT:    v_or_b32_e32 v17, v18, v17
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 3, s16
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 58
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 2, s16
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    v_and_b32_e32 v19, 1, v19
...
; GCN-NEXT:    v_or_b32_e32 v18, v18, v19
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 1, s16
; GCN-NEXT:    v_cndmask_b32_e32 v20, 1, v20, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    v_and_b32_e32 v20, 1, v20
...
; GCN-NEXT:    v_or_b32_sdwa v16, v16, v17 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NEXT:    v_lshrrev_b16_e64 v17, 15, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 46
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 14, s5
; GCN-NEXT:    v_cndmask_b32_e32 v17, 1, v17, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    v_and_b32_e32 v18, 1, v18
...
; GCN-NEXT:    v_or_b32_e32 v17, v17, v18
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 13, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 44
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 12, s5
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    v_lshlrev_b16_e32 v18, 1, v18
...
; GCN-NEXT:    v_or_b32_e32 v17, v18, v17
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 11, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 42
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 10, s5
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    v_and_b32_e32 v19, 1, v19
...
; GCN-NEXT:    v_or_b32_e32 v18, v18, v19
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 9, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 40
; GCN-NEXT:    v_lshrrev_b16_e64 v20, 8, s5
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v20, 1, v20, vcc
; GCN-NEXT:    v_lshlrev_b16_e32 v19, 1, v19
...
; GCN-NEXT:    v_or_b32_e32 v17, v17, v18
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 7, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 38
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 6, s5
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    v_and_b32_e32 v19, 1, v19
...
; GCN-NEXT:    v_or_b32_e32 v18, v18, v19
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 5, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 36
; GCN-NEXT:    v_lshrrev_b16_e64 v20, 4, s5
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v20, 1, v20, vcc
; GCN-NEXT:    v_lshlrev_b16_e32 v19, 1, v19
...
; GCN-NEXT:    v_or_b32_e32 v18, v19, v18
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 3, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 34
; GCN-NEXT:    v_lshrrev_b16_e64 v20, 2, s5
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v19, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v20, 1, v20, vcc
; GCN-NEXT:    v_and_b32_e32 v20, 1, v20
...
; GCN-NEXT:    v_or_b32_e32 v19, v19, v20
; GCN-NEXT:    v_lshrrev_b16_e64 v20, 1, s5
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_sdwa v1, v1, v17 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NEXT:    s_cmp_lg_u32 s0, 23
; GCN-NEXT:    v_or_b32_sdwa v1, v1, v16 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GCN-NEXT:    v_mov_b32_e32 v16, s15
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 22
; GCN-NEXT:    v_cndmask_b32_e32 v16, 1, v16, vcc
; GCN-NEXT:    v_mov_b32_e32 v17, s14
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v17, 1, v17, vcc
; GCN-NEXT:    v_and_b32_e32 v17, 1, v17
; GCN-NEXT:    v_lshlrev_b16_e32 v16, 3, v16
...
; GCN-NEXT:    v_cndmask_b32_e32 v17, 1, v17, vcc
; GCN-NEXT:    v_mov_b32_e32 v18, s12
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    v_lshlrev_b16_e32 v17, 1, v17
; GCN-NEXT:    v_and_b32_e32 v18, 1, v18
...
; GCN-NEXT:    v_or_b32_e32 v16, v17, v16
; GCN-NEXT:    v_mov_b32_e32 v17, s11
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_e32 v16, v17, v16
; GCN-NEXT:    v_lshrrev_b16_e64 v17, 7, s1
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 30
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 6, s1
; GCN-NEXT:    v_cndmask_b32_e32 v17, 1, v17, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    v_and_b32_e32 v18, 1, v18
...
; GCN-NEXT:    v_or_b32_e32 v17, v17, v18
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 5, s1
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_e32 v17, v18, v17
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 3, s1
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_or_b32_sdwa v16, v16, v17 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NEXT:    v_lshrrev_b16_e64 v17, 15, s4
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 14
; GCN-NEXT:    v_lshrrev_b16_e64 v18, 14, s4
; GCN-NEXT:    v_cndmask_b32_e32 v17, 1, v17, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v18, vcc
; GCN-NEXT:    v_and_b32_e32 v18, 1, v18
; GCN-NEXT:    s_cmp_lg_u32 s0, 13
; GCN-NEXT:    v_lshrrev_b16_e64 v19, 13, s4
; GCN-NEXT:    v_lshlrev_b16_e32 v17, 3, v17
; GCN-NEXT:    v_lshlrev_b16_e32 v18, 2, v18
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 12
; GCN-NEXT:    v_lshrrev_b16_e64 v20, 12, s4
; GCN-NEXT:    v_or_b32_e32 v17, v17, v18
; GCN-NEXT:    v_cndmask_b32_e32 v18, 1, v19, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s0, 11
; GCN-NEXT:    v_lshrrev_b16_e64 v14, 11, s4
; GCN-NEXT:    v_cndmask_b32_e32 v19, 1, v20, vcc
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_lshlrev_b16_e32 v17, 12, v17
; GCN-NEXT:    v_and_b32_sdwa v11, v11, v15 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GCN-NEXT:    v_mov_b32_e32 v5, s3
; GCN-NEXT:    v_or_b32_sdwa v0, v0, v16 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GCN-NEXT:    v_mov_b32_e32 v4, s2
; GCN-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GCN-NEXT:    s_endpgm
entry:
