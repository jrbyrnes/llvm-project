...
define amdgpu_kernel void @rule2(ptr addrspace(7) noalias %in, ptr addrspace(3) noalias %out, i64 %idx0, i64 %idx1, i64 %idx2, i64 %idx3, i64 %val, i64 %tid) #0 {
; GCN-LABEL: rule2:
; GCN:       ; %bb.0: ; %entry
...
; GCN-NEXT:    s_add_i64 s0, s0, s12
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_add_i64 s1, s1, s13
; GCN-NEXT:    s_add_i64 s3, s3, s12
; GCN-NEXT:    s_add_i64 s8, s8, s13
; GCN-NEXT:    s_add_i64 s9, s9, s12
; GCN-NEXT:    s_add_i64 s10, s10, s13
; GCN-NEXT:    s_add_i64 s12, s14, s12
; GCN-NEXT:    s_add_i64 s11, s11, s13
; GCN-NEXT:    v_lshlrev_b32_e32 v0, 5, v0
; GCN-NEXT:    s_add_i64 s0, s0, 32
; GCN-NEXT:    s_add_i64 s1, s1, 4
; GCN-NEXT:    s_add_i64 s3, s3, 32
; GCN-NEXT:    s_add_i64 s8, s8, 4
; GCN-NEXT:    s_add_i64 s9, s9, 32
; GCN-NEXT:    s_add_i64 s10, s10, 4
; GCN-NEXT:    s_add_i64 s12, s12, 32
; GCN-NEXT:    s_add_i64 s11, s11, 4
...
; GCN-NEXT:    s_endpgm
entry:
  %gepPtr = getelementptr ptr addrspace(7), ptr addrspace(7) %in, i64 %tid
  %outPtr = getelementptr ptr addrspace(7), ptr addrspace(3) %out, i64 %tid
  %gep0 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx0
  %gep1 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx1
  %gep2 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx2
  %gep3 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx3
...
bb.1:
  ...
  %val1 = phi i64 [%val, %entry], [%val2, %bb.1]
  %idx8 = phi i64 [%idx0, %entry], [%idx4, %bb.1]
  %idx9 = phi i64 [%idx1, %entry], [%idx5, %bb.1]
  %idx10 = phi i64 [%idx2, %entry], [%idx6, %bb.1]
  %idx11 = phi i64 [%idx3, %entry], [%idx7, %bb.1]
  ...
  %idx4 = add i64 %idx8, 1
  %idx5 = add i64 %idx9, 1
  %idx6 = add i64 %idx10, 1
  %idx7 = add i64 %idx11, 1
  %out0 =  getelementptr ptr addrspace(3), ptr addrspace(3) %outPtr, i64 %idx4
  %out1 =  getelementptr ptr addrspace(3), ptr addrspace(3) %outPtr, i64 %idx5
  %out2 =  getelementptr ptr addrspace(3), ptr addrspace(3) %outPtr, i64 %idx6
  %out3 =  getelementptr ptr addrspace(3), ptr addrspace(3) %outPtr, i64 %idx7
  ...
  %gep4 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx4
  %gep5 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx5
  %gep6 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx6
  %gep7 =  getelementptr ptr addrspace(7), ptr addrspace(7) %gepPtr, i64 %idx7
