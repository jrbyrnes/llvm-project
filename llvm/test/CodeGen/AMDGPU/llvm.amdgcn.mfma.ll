...
; RUN: llc -mtriple=amdgcn -mcpu=gfx908 -verify-machineinstrs < %s | FileCheck -enable-var-scope --check-prefixes=NOLIT-SRCC %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx908 -mattr=-mfma-inline-literal-bug -verify-machineinstrs < %s | FileCheck -enable-var-scope --check-prefixes=LIT-SRCC %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx90a -verify-machineinstrs < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx940 -verify-machineinstrs < %s | FileCheck -enable-var-scope --check-prefixes=GFX940 %s
...
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v2, a0
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v5, a0
; NOLIT-SRCC-NEXT:    v_accvgpr_write_b32 a1, v1
; NOLIT-SRCC-NEXT:    v_accvgpr_write_b32 a2, v2
; NOLIT-SRCC-NEXT:    v_accvgpr_write_b32 a3, v5
; NOLIT-SRCC-NEXT:    v_mov_b32_e32 v1, 2.0
...
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v2, a0
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v5, a0
; LIT-SRCC-NEXT:    v_accvgpr_write_b32 a1, v1
; LIT-SRCC-NEXT:    v_accvgpr_write_b32 a2, v2
; LIT-SRCC-NEXT:    v_accvgpr_write_b32 a3, v5
; LIT-SRCC-NEXT:    v_mov_b32_e32 v1, 2.0
