...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    s_add_i32 s1, s0, s0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_mul_u32_u24_sdwa v3, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v1, v2, s0
; GFX9-NODL-NEXT:    v_add3_u32 v1, s1, v3, v1
; GFX9-NODL-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-NODL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-NODL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-NODL-NEXT:    s_mov_b32 s1, 0xc020003
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    global_load_dword v1, v0, s[6:7]
; GFX9-NODL-NEXT:    global_load_dword v2, v0, s[4:5]
; GFX9-NODL-NEXT:    s_load_dword s0, s[2:3], 0x0
...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v1, v2, 0
; GFX9-NODL-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-NODL-NEXT:    s_mov_b32 s1, 0x3020504
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_perm_b32 v1, v1, v2, s1
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v3, v1, s0
...
; GFX9-NODL-NEXT:    global_load_dword v3, v0, s[0:1]
; GFX9-NODL-NEXT:    s_load_dword s0, s[6:7], 0x0
; GFX9-NODL-NEXT:    s_mov_b32 s1, 0xc060100
; GFX9-NODL-NEXT:    s_mov_b32 s2, 0xc020100
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_perm_b32 v1, v2, v1, s1
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_perm_b32 v2, v3, v3, s2
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v2, v1, s0
; GFX9-NODL-NEXT:    global_store_dword v0, v1, s[6:7]
; GFX9-NODL-NEXT:    s_endpgm
