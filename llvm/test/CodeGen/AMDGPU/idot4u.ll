...
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v1, v2, s0
...
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v0, v2, v3, v4
...
; GFX9-NODL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-NODL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-NODL-NEXT:    s_mov_b32 s0, 0xc0c0100
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    global_load_dword v1, v0, s[4:5]
; GFX9-NODL-NEXT:    global_load_dword v2, v0, s[6:7]
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX9-NODL-NEXT:    v_perm_b32 v1, v1, v1, s0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_perm_b32 v2, v2, v2, s0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v3
...
; GFX9-NODL-NEXT:    global_load_ubyte v4, v1, s[2:3]
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v0, v3, v2, v4
; GFX9-NODL-NEXT:    global_store_byte v1, v0, s[2:3]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-NODL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-NODL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-NODL-NEXT:    s_mov_b32 s0, 0xc0c0302
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    global_load_dword v1, v0, s[4:5]
; GFX9-NODL-NEXT:    global_load_dword v2, v0, s[6:7]
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NODL-NEXT:    global_load_ubyte v3, v0, s[2:3]
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(2)
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v4, 8, v1
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v5, 8, v2
; GFX9-NODL-NEXT:    v_perm_b32 v6, v1, v1, s0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_mad_legacy_u16 v3, v5, v4, v3
; GFX9-NODL-NEXT:    v_mad_legacy_u16 v1, v2, v1, v3
; GFX9-NODL-NEXT:    v_and_b32_e32 v1, 0xff, v1
; GFX9-NODL-NEXT:    v_perm_b32 v2, v2, v2, s0
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v2, v6, v1
; GFX9-NODL-NEXT:    global_store_byte v0, v1, s[2:3]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    global_load_ubyte v3, v0, s[2:3]
; GFX9-DL-NEXT:    s_waitcnt vmcnt(2)
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v4, 8, v1
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v5, 8, v2
; GFX9-DL-NEXT:    v_perm_b32 v6, v1, v1, s0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_mad_legacy_u16 v3, v5, v4, v3
...
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v3, v2, v0
; GFX10-DL-NEXT:    global_store_byte v1, v0, s[2:3]
; GFX10-DL-NEXT:    s_endpgm
                                                        ptr addrspace(1) %src2,
                                                        ptr addrspace(1) nocapture %dst) {
...
; GFX9-NODL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-NODL-NEXT:    s_mov_b32 s0, 0xc0c0100
; GFX9-NODL-NEXT:    s_mov_b32 s1, 0xc0c0302
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    global_load_dword v1, v0, s[4:5]
; GFX9-NODL-NEXT:    global_load_dword v2, v0, s[6:7]
; GFX9-NODL-NEXT:    s_load_dword s4, s[2:3], 0x0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_perm_b32 v6, v1, v1, s0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_perm_b32 v5, v2, v2, s0
; GFX9-NODL-NEXT:    v_and_b32_e32 v3, 0xff, v1
; GFX9-NODL-NEXT:    v_and_b32_e32 v4, 0xff, v2
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v5, v6, v5, s4
; GFX9-NODL-NEXT:    v_perm_b32 v2, v2, v2, s1
; GFX9-NODL-NEXT:    v_mad_u32_u24 v3, v3, v4, v5
; GFX9-NODL-NEXT:    v_perm_b32 v1, v1, v1, s1
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v3
; GFX9-NODL-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-DL-NEXT:    s_mov_b32 s0, 0xc0c0100
; GFX9-DL-NEXT:    s_mov_b32 s1, 0xc0c0302
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    global_load_dword v1, v0, s[4:5]
; GFX9-DL-NEXT:    global_load_dword v2, v0, s[6:7]
; GFX9-DL-NEXT:    s_load_dword s4, s[2:3], 0x0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_perm_b32 v6, v1, v1, s0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_perm_b32 v5, v2, v2, s0
; GFX9-DL-NEXT:    v_and_b32_e32 v3, 0xff, v1
; GFX9-DL-NEXT:    v_and_b32_e32 v4, 0xff, v2
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_dot4_u32_u8 v5, v6, v5, s4
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v2, s1
; GFX9-DL-NEXT:    v_mad_u32_u24 v3, v3, v4, v5
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_perm_b32 v3, v2, v2, 0xc0c0100
; GFX10-DL-NEXT:    v_and_b32_e32 v4, 0xff, v2
; GFX10-DL-NEXT:    v_and_b32_e32 v5, 0xff, v1
; GFX10-DL-NEXT:    v_perm_b32 v1, v1, v1, 0xc0c0302
; GFX10-DL-NEXT:    v_perm_b32 v2, v2, v2, 0xc0c0302
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v3, v0, s2
; GFX10-DL-NEXT:    v_mov_b32_e32 v3, 0
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v4, v5, v0
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v2, v1, v0
...
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_bfe_u32 v6, v2, 8, 8
; GFX9-NODL-NEXT:    v_and_b32_e32 v3, 0xff, v1
; GFX9-NODL-NEXT:    v_and_b32_e32 v4, 0xff, v2
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    v_mad_u32_u24 v5, v5, v6, s1
; GFX9-NODL-NEXT:    v_perm_b32 v2, v2, v2, s0
; GFX9-NODL-NEXT:    v_mad_u32_u24 v3, v3, v4, v5
; GFX9-NODL-NEXT:    v_perm_b32 v1, v1, v1, s0
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v3
; GFX9-NODL-NEXT:    v_add3_u32 v1, v5, s1, v1
; GFX9-NODL-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v5, v1, 8, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_bfe_u32 v6, v2, 8, 8
; GFX9-DL-NEXT:    v_and_b32_e32 v3, 0xff, v1
; GFX9-DL-NEXT:    v_and_b32_e32 v4, 0xff, v2
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_mad_u32_u24 v5, v5, v6, s1
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v2, s0
; GFX9-DL-NEXT:    v_mad_u32_u24 v3, v3, v4, v5
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v1, s0
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v3
; GFX9-DL-NEXT:    v_add3_u32 v1, v5, s1, v1
; GFX9-DL-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX9-DL-NEXT:    s_endpgm
;
...
; GFX10-DL-NEXT:    v_and_b32_e32 v5, 0xff, v2
; GFX10-DL-NEXT:    v_perm_b32 v2, v2, v2, 0xc0c0302
; GFX10-DL-NEXT:    v_perm_b32 v1, v1, v1, 0xc0c0302
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v0, v3, s2
; GFX10-DL-NEXT:    v_mad_u32_u24 v3, v4, v5, v0
; GFX10-DL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v3
...
; GFX9-NODL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-NODL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-NODL-NEXT:    s_mov_b32 s1, 0xc0c0100
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NODL-NEXT:    v_perm_b32 v2, v2, v2, s1
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    v_dot4_u32_u8 v1, v2, v1, s0
; GFX9-NODL-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-NODL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-NODL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-NODL-NEXT:    s_mov_b32 s1, 0xc020100
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    global_load_dword v1, v0, s[6:7]
; GFX9-NODL-NEXT:    global_load_dword v2, v0, s[4:5]
; GFX9-NODL-NEXT:    s_load_dword s0, s[2:3], 0x0
...
define amdgpu_kernel void @idot4_acc32_last3ele(ptr addrspace(1) %src1,
; GFX7-LABEL: idot4_acc32_last3ele:
; GFX7:       ; %bb.0: ; %entry
; GFX7-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x9
; GFX7-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xd
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX7-NEXT:    s_endpgm
;
; GFX8-LABEL: idot4_acc32_last3ele:
; GFX8:       ; %bb.0: ; %entry
; GFX8-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x24
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x34
; GFX8-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
...
; GFX8-NEXT:    s_load_dword s2, s[0:1], 0x0
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_bfe_u32 v1, v3, 8, 8
; GFX8-NEXT:    v_bfe_u32 v4, v3, 16, 8
; GFX8-NEXT:    v_lshrrev_b32_e32 v3, 24, v3
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_bfe_u32 v2, v0, 8, 8
...
; GFX8-NEXT:    s_endpgm
;
; GFX9-NODL-LABEL: idot4_acc32_last3ele:
; GFX9-NODL:       ; %bb.0: ; %entry
; GFX9-NODL-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x24
; GFX9-NODL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-NODL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-NODL-NEXT:    s_mov_b32 s1, 0xc030201
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    global_load_dword v1, v0, s[6:7]
; GFX9-NODL-NEXT:    global_load_dword v2, v0, s[4:5]
; GFX9-NODL-NEXT:    s_load_dword s0, s[2:3], 0x0
...
; GFX9-NODL-NEXT:    s_endpgm
;
; GFX9-DL-LABEL: idot4_acc32_last3ele:
; GFX9-DL:       ; %bb.0: ; %entry
; GFX9-DL-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x24
; GFX9-DL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-DL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-DL-NEXT:    s_mov_b32 s1, 0xc030201
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    global_load_dword v1, v0, s[6:7]
; GFX9-DL-NEXT:    global_load_dword v2, v0, s[4:5]
; GFX9-DL-NEXT:    s_load_dword s0, s[2:3], 0x0
...
; GFX9-DL-NEXT:    s_endpgm
;
; GFX10-DL-LABEL: idot4_acc32_last3ele:
; GFX10-DL:       ; %bb.0: ; %entry
; GFX10-DL-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x24
; GFX10-DL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX10-DL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x34
...
; GFX10-DL-NEXT:    s_load_dword s2, s[0:1], 0x0
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX10-DL-NEXT:    v_perm_b32 v0, v1, v1, 0xc030201
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_perm_b32 v1, v2, v2, 0xc030201
; GFX10-DL-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v1, v0, s2
; GFX10-DL-NEXT:    global_store_dword v2, v0, s[0:1]
...
entry:
  ...
  %v1e0 = extractelement <4 x i8> %vec1, i64 1
  %cv1e0 = zext i8 %v1e0 to i32
  %v2e0 = extractelement <4 x i8> %vec2, i64 1
  %cv2e0 = zext i8 %v2e0 to i32
  %mul1 = mul nuw nsw i32 %cv1e0, %cv2e0

  %v1e1 = extractelement <4 x i8> %vec1, i64 2
  %cv1e1 = zext i8 %v1e1 to i32
  %v2e1 = extractelement <4 x i8> %vec2, i64 2
  %cv2e1 = zext i8 %v2e1 to i32
  %mul2 = mul nuw nsw i32 %cv1e1, %cv2e1

  %v1e2 = extractelement <4 x i8> %vec1, i64 3
  %cv1e2 = zext i8 %v1e2 to i32
  %v2e2 = extractelement <4 x i8> %vec2, i64 3
  %cv2e2 = zext i8 %v2e2 to i32
  %mul3 = mul nuw nsw i32 %cv1e2, %cv2e2
...
; GFX10-DL-NEXT:    v_perm_b32 v2, v2, v2, 0xc0c0302
; GFX10-DL-NEXT:    v_perm_b32 v1, v1, v1, 0xc0c0302
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v0, v3, v4
; GFX10-DL-NEXT:    v_mov_b32_e32 v3, 0
