...
; GFX7-NEXT:    s_cbranch_vccnz .LBB2_8
...
; GFX7-NEXT:    s_cbranch_execnz .LBB2_11
; GFX7-NEXT:  ; %bb.12: ; %Flow
; GFX7-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX7-NEXT:  .LBB2_13: ; %Flow16
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX8-NEXT:    s_cbranch_vccnz .LBB2_8
; GFX8-NEXT:  ; %bb.9: ; %ComputeEnd
...
; GFX8-NEXT:    s_cbranch_execz .LBB2_13
; GFX8-NEXT:  ; %bb.10:
; GFX8-NEXT:    v_mov_b32_e32 v3, s2
; GFX8-NEXT:    s_mov_b32 m0, -1
; GFX8-NEXT:    ds_read_b32 v2, v3
; GFX8-NEXT:    s_mov_b64 s[2:3], 0
; GFX8-NEXT:  .LBB2_11: ; %atomicrmw.start8
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_cbranch_execnz .LBB2_11
; GFX8-NEXT:  ; %bb.12: ; %Flow
; GFX8-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX8-NEXT:  .LBB2_13: ; %Flow18
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX7-NEXT:    v_add_f32_e32 v1, s9, v1
; GFX7-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7-NEXT:    s_cbranch_vccnz .LBB3_8
; GFX7-NEXT:  ; %bb.9: ; %ComputeEnd
; GFX7-NEXT:    v_mbcnt_lo_u32_b32_e64 v2, exec_lo, 0
; GFX7-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, exec_hi, v2
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
...
; GFX7-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX7-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7-NEXT:    s_cbranch_execz .LBB3_13
; GFX7-NEXT:  ; %bb.10:
; GFX7-NEXT:    v_mov_b32_e32 v3, s2
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    ds_read_b32 v2, v3
; GFX7-NEXT:    s_mov_b64 s[2:3], 0
; GFX7-NEXT:  .LBB3_11: ; %atomicrmw.start8
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v4, v2
; GFX7-NEXT:    v_add_f32_e32 v2, v4, v1
...
; GFX7-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
; GFX7-NEXT:    s_andn2_b64 exec, exec, s[2:3]
; GFX7-NEXT:    s_cbranch_execnz .LBB3_11
; GFX7-NEXT:  ; %bb.12: ; %Flow
; GFX7-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX7-NEXT:  .LBB3_13: ; %Flow16
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7-NEXT:    v_readfirstlane_b32 s4, v2
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX8-NEXT:    v_add_f32_e32 v1, s9, v1
; GFX8-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX8-NEXT:    s_cbranch_vccnz .LBB3_8
; GFX8-NEXT:  ; %bb.9: ; %ComputeEnd
; GFX8-NEXT:    v_mbcnt_lo_u32_b32_e64 v2, exec_lo, 0
; GFX8-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, exec_hi, v2
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
...
; GFX8-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cbranch_execz .LBB3_13
; GFX8-NEXT:  ; %bb.10:
; GFX8-NEXT:    v_mov_b32_e32 v3, s2
; GFX8-NEXT:    s_mov_b32 m0, -1
; GFX8-NEXT:    ds_read_b32 v2, v3
; GFX8-NEXT:    s_mov_b64 s[2:3], 0
; GFX8-NEXT:  .LBB3_11: ; %atomicrmw.start8
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v4, v2
; GFX8-NEXT:    v_add_f32_e32 v2, v4, v1
...
; GFX8-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
; GFX8-NEXT:    s_andn2_b64 exec, exec, s[2:3]
; GFX8-NEXT:    s_cbranch_execnz .LBB3_11
; GFX8-NEXT:  ; %bb.12: ; %Flow
; GFX8-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX8-NEXT:  .LBB3_13: ; %Flow18
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX8-NEXT:    v_readfirstlane_b32 s4, v2
; GFX8-NEXT:    s_mov_b32 s3, 0xf000
