...
; GFX908-NEXT:    v_mov_b32_e32 v3, 0x41000000
...
; GFX908-NEXT:    v_mov_b32_e32 v3, 0x41300000
...
; GFX908-NEXT:    v_accvgpr_write_b32 a10, v3
; GFX908-NEXT:    v_mov_b32_e32 v3, 0x41600000
...
; GFX908-NEXT:    v_accvgpr_write_b32 a13, v3
; GFX908-NEXT:    v_mov_b32_e32 v3, 0x41880000
...
; GFX908-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX908-NEXT:    v_accvgpr_write_b32 a16, v3
; GFX908-NEXT:    v_mov_b32_e32 v3, 0x41a00000
...
; GFX908-NEXT:    v_mov_b32_e32 v4, 0x41b80000
; GFX908-NEXT:    v_mov_b32_e32 v5, 0x41c00000
; GFX908-NEXT:    v_mov_b32_e32 v6, 0x41c80000
; GFX908-NEXT:    v_mov_b32_e32 v7, 0x41d00000
; GFX908-NEXT:    v_mov_b32_e32 v8, 0x41d80000
; GFX908-NEXT:    v_mov_b32_e32 v9, 0x41e00000
; GFX908-NEXT:    v_mov_b32_e32 v10, 0x41e80000
; GFX908-NEXT:    v_mov_b32_e32 v11, 0x41f00000
; GFX908-NEXT:    v_mov_b32_e32 v12, 0x41f80000
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ;;#ASMEND
; GFX908-NEXT:    v_accvgpr_read_b32 v13, a0
; GFX908-NEXT:    v_accvgpr_write_b32 a0, 1.0
; GFX908-NEXT:    v_accvgpr_write_b32 a1, 2.0
; GFX908-NEXT:    v_accvgpr_write_b32 a3, 4.0
; GFX908-NEXT:    v_accvgpr_write_b32 a19, v3
; GFX908-NEXT:    v_accvgpr_write_b32 a20, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a21, v2
; GFX908-NEXT:    v_accvgpr_write_b32 a22, v4
; GFX908-NEXT:    v_accvgpr_write_b32 a23, v5
; GFX908-NEXT:    v_accvgpr_write_b32 a24, v6
; GFX908-NEXT:    v_accvgpr_write_b32 a25, v7
; GFX908-NEXT:    v_accvgpr_write_b32 a26, v8
; GFX908-NEXT:    v_accvgpr_write_b32 a27, v9
; GFX908-NEXT:    v_accvgpr_write_b32 a28, v10
; GFX908-NEXT:    v_accvgpr_write_b32 a29, v11
; GFX908-NEXT:    v_accvgpr_write_b32 a30, v12
...
; GFX908-NEXT:    s_nop 7
; GFX908-NEXT:    s_nop 5
; GFX908-NEXT:    v_accvgpr_write_b32 a1, v13
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ;;#ASMEND
; GFX908-NEXT:    s_nop 1
...
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    s_nop 0
; GFX908-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX908-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    v_mov_b32_e32 v3, 0x41f00000
; GFX90A-NEXT:    v_mov_b32_e32 v4, 0x41f80000
...
; GFX90A-NEXT:    v_accvgpr_write_b32 a30, v4
; GFX90A-NEXT:    v_accvgpr_mov_b32 a31, a1
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v0, v0, a[0:31]
...
; GFX90A-NEXT:    ;;#ASMEND
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    global_store_dword v0, a0, s[0:1]
; GFX90A-NEXT:    s_endpgm
bb:
...
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    global_load_dwordx4 v[1:4], v1, s[0:1]
...
; GFX908-NEXT:    v_accvgpr_read_b32 v5, a4 ; Reload Reuse
; GFX908-NEXT:    s_nop 1
...
; GFX908-NEXT:    s_nop 1
; GFX908-NEXT:    v_mfma_f32_4x4x1f32 a[0:3], v1, v1, a[0:3]
; GFX908-NEXT:    s_nop 3
...
; GFX908-NEXT:    buffer_load_dword v1, off, s[4:7], 0 ; 4-byte Folded Reload
; GFX908-NEXT:    s_nop 0
; GFX908-NEXT:    buffer_load_dword v2, off, s[4:7], 0 offset:4 ; 4-byte Folded Reload
; GFX908-NEXT:    buffer_load_dword v3, off, s[4:7], 0 offset:8 ; 4-byte Folded Reload
; GFX908-NEXT:    buffer_load_dword v4, off, s[4:7], 0 offset:12 ; 4-byte Folded Reload
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_store_dwordx4 v[0:1], v[1:4], off
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_accvgpr_read_b32 v0, a5
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ; use v0
; GFX908-NEXT:    ;;#ASMEND
; GFX908-NEXT:    s_endpgm
...
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    v_mfma_f32_4x4x1f32 a[0:3], v0, v0, a[0:3]
; GFX90A-NEXT:    v_accvgpr_read_b32 v0, a4
; GFX90A-NEXT:    s_nop 3
