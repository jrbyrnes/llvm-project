...
define dso_local i32 @single_block_referrer_live_until_terminator() #1 !dbg !5 {
  ...
  ; CHECK: bb.0.entry:
  ; CHECK-NEXT:   INLINEASM &"S_NOP 1 ; def $0", 1 /* sideeffect attdialect */, 2424842 /* regdef:SReg_32 */, def renamable $sgpr4
...
define dso_local void @single_block_dangling_referrer_live_until_terminator() #1 !dbg !16 {
  ...
  ; CHECK-NEXT:   INLINEASM &"S_NOP 1 ; def $0", 1 /* sideeffect attdialect */, 2424842 /* regdef:SReg_32 */, def renamable $sgpr4
  ; CHECK-NEXT:   INLINEASM &"S_NOP 1", 1 /* sideeffect attdialect */
  ; CHECK-NEXT:   INLINEASM &"S_NOP 1 ; use $0", 1 /* sideeffect attdialect */, 2424841 /* reguse:SReg_32 */, killed renamable $sgpr4
  ; CHECK-NEXT:   INLINEASM &"S_NOP 1", 1 /* sideeffect attdialect */
