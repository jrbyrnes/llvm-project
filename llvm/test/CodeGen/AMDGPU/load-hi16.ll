...
; GFX900-MUBUF-LABEL: load_local_lo_hi_v2i16_multi_use_hi:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    ds_read_u16 v1, v0 offset:16
...
; GFX900-MUBUF-NEXT:    ds_write_b16 v2, v1
; GFX900-MUBUF-NEXT:    s_waitcnt lgkmcnt(1)
...
; GFX900-MUBUF-LABEL: load_local_lo_hi_v2i16_multi_use_lohi:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    ds_read_u16 v3, v0
; GFX900-MUBUF-NEXT:    ds_read_u16 v0, v0 offset:16
; GFX900-MUBUF-NEXT:    s_mov_b32 s4, 0x5040100
; GFX900-MUBUF-NEXT:    s_waitcnt lgkmcnt(1)
; GFX900-MUBUF-NEXT:    ds_write_b16 v1, v3
; GFX900-MUBUF-NEXT:    s_waitcnt lgkmcnt(1)
; GFX900-MUBUF-NEXT:    ds_write_b16 v2, v0
; GFX900-MUBUF-NEXT:    v_perm_b32 v0, v0, v3, s4
; GFX900-MUBUF-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_short_d16_hi v0, off, s[0:3], s32 offset:4094
...
; GFX900-MUBUF-LABEL: load_private_hi_v2f16_reglo_vreg:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_short_d16_hi v0, off, s[0:3], s32 offset:4094
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_nooff:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_short_d16_hi v0, off, s[0:3], 0 offset:4094 glc
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    global_store_dword v[0:1], v0, off
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-MUBUF-LABEL: load_private_hi_v2f16_reglo_vreg_nooff:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_short_d16_hi v1, off, s[0:3], 0 offset:4094 glc
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_zexti8:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_ubyte_d16_hi v0, off, s[0:3], s32 offset:4095
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    global_store_dword v[0:1], v0, off
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-MUBUF-LABEL: load_private_hi_v2f16_reglo_vreg_zexti8:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_ubyte_d16_hi v0, off, s[0:3], s32 offset:4095
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900-MUBUF-LABEL: load_private_hi_v2f16_reglo_vreg_sexti8:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_sbyte_d16_hi v0, off, s[0:3], s32 offset:4095
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    global_store_dword v[0:1], v0, off
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_sexti8:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_sbyte_d16_hi v0, off, s[0:3], s32 offset:4095
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_nooff_zexti8:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_ubyte_d16_hi v1, off, s[0:3], 0 offset:4094 glc
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_nooff_sexti8:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_sbyte_d16_hi v1, off, s[0:3], 0 offset:4094 glc
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900-MUBUF-LABEL: load_private_hi_v2f16_reglo_vreg_nooff_zexti8:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_ubyte_d16_hi v1, off, s[0:3], 0 offset:4094 glc
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_to_offset:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    v_mov_b32_e32 v2, 0x7b
; GFX900-MUBUF-NEXT:    buffer_store_dword v2, v1, s[0:3], 0 offen
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_short_d16_hi v0, off, s[0:3], s32 offset:4058
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    global_store_dword v[0:1], v0, off
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_sexti8_to_offset:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    v_mov_b32_e32 v2, 0x7b
; GFX900-MUBUF-NEXT:    buffer_store_dword v2, v1, s[0:3], 0 offen
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_sbyte_d16_hi v0, off, s[0:3], s32 offset:4059
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    global_store_dword v[0:1], v0, off
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-MUBUF-LABEL: load_private_hi_v2i16_reglo_vreg_zexti8_to_offset:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    v_mov_b32_e32 v2, 0x7b
; GFX900-MUBUF-NEXT:    buffer_store_dword v2, v1, s[0:3], 0 offen
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_ubyte_d16_hi v0, off, s[0:3], s32 offset:4059
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    global_store_dword v[0:1], v0, off
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-MUBUF-LABEL: load_local_v2i16_broadcast:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    ds_read_u16 v0, v0
; GFX900-MUBUF-NEXT:    s_mov_b32 s4, 0x5040100
; GFX900-MUBUF-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-MUBUF-NEXT:    v_perm_b32 v0, v0, v0, s4
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-MUBUF-LABEL: load_private_v2i16_split:
; GFX900-MUBUF:       ; %bb.0: ; %entry
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_ushort v0, off, s[0:3], s32 glc
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    buffer_load_short_d16_hi v0, off, s[0:3], s32 offset:2 glc
; GFX900-MUBUF-NEXT:    s_waitcnt vmcnt(0)
; GFX900-MUBUF-NEXT:    s_setpc_b64 s[30:31]
;
