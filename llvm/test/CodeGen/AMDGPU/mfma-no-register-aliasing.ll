...
; RUN: llc -mtriple=amdgcn -mcpu=gfx940 -verify-machineinstrs < %s | FileCheck -enable-var-scope --check-prefixes=GREEDY940 %s
...
; GREEDY908:       ; %bb.0: ; %bb
; GREEDY908-NEXT:    s_load_dwordx2 s[34:35], s[0:1], 0x24
...
; GREEDY90A:       ; %bb.0: ; %bb
; GREEDY90A-NEXT:    s_load_dwordx2 s[34:35], s[0:1], 0x24
...
;
; GREEDY940-LABEL: test_mfma_f32_32x32x1f32:
; GREEDY940:       ; %bb.0: ; %bb
; GREEDY940-NEXT:    s_load_dwordx2 s[34:35], s[0:1], 0x24
; GREEDY940-NEXT:    v_mov_b32_e32 v0, 1.0
; GREEDY940-NEXT:    v_mov_b32_e32 v1, 2.0
; GREEDY940-NEXT:    v_mov_b32_e32 v2, 0
; GREEDY940-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY940-NEXT:    s_load_dwordx16 s[16:31], s[34:35], 0x0
; GREEDY940-NEXT:    s_load_dwordx16 s[0:15], s[34:35], 0x40
; GREEDY940-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY940-NEXT:    v_accvgpr_write_b32 a0, s16
; GREEDY940-NEXT:    v_accvgpr_write_b32 a1, s17
; GREEDY940-NEXT:    v_accvgpr_write_b32 a2, s18
; GREEDY940-NEXT:    v_accvgpr_write_b32 a3, s19
; GREEDY940-NEXT:    v_accvgpr_write_b32 a4, s20
; GREEDY940-NEXT:    v_accvgpr_write_b32 a5, s21
; GREEDY940-NEXT:    v_accvgpr_write_b32 a6, s22
; GREEDY940-NEXT:    v_accvgpr_write_b32 a7, s23
; GREEDY940-NEXT:    v_accvgpr_write_b32 a8, s24
; GREEDY940-NEXT:    v_accvgpr_write_b32 a9, s25
; GREEDY940-NEXT:    v_accvgpr_write_b32 a10, s26
; GREEDY940-NEXT:    v_accvgpr_write_b32 a11, s27
; GREEDY940-NEXT:    v_accvgpr_write_b32 a12, s28
; GREEDY940-NEXT:    v_accvgpr_write_b32 a13, s29
; GREEDY940-NEXT:    v_accvgpr_write_b32 a14, s30
; GREEDY940-NEXT:    v_accvgpr_write_b32 a15, s31
; GREEDY940-NEXT:    v_accvgpr_write_b32 a16, s0
; GREEDY940-NEXT:    v_accvgpr_write_b32 a17, s1
; GREEDY940-NEXT:    v_accvgpr_write_b32 a18, s2
; GREEDY940-NEXT:    v_accvgpr_write_b32 a19, s3
; GREEDY940-NEXT:    v_accvgpr_write_b32 a20, s4
; GREEDY940-NEXT:    v_accvgpr_write_b32 a21, s5
; GREEDY940-NEXT:    v_accvgpr_write_b32 a22, s6
; GREEDY940-NEXT:    v_accvgpr_write_b32 a23, s7
; GREEDY940-NEXT:    v_accvgpr_write_b32 a24, s8
; GREEDY940-NEXT:    v_accvgpr_write_b32 a25, s9
; GREEDY940-NEXT:    v_accvgpr_write_b32 a26, s10
; GREEDY940-NEXT:    v_accvgpr_write_b32 a27, s11
; GREEDY940-NEXT:    v_accvgpr_write_b32 a28, s12
; GREEDY940-NEXT:    v_accvgpr_write_b32 a29, s13
; GREEDY940-NEXT:    v_accvgpr_write_b32 a30, s14
; GREEDY940-NEXT:    v_accvgpr_write_b32 a31, s15
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    v_mfma_f32_32x32x1_2b_f32 a[0:31], v0, v1, a[0:31]
; GREEDY940-NEXT:    v_mfma_f32_32x32x1_2b_f32 a[32:63], v0, v1, a[0:31]
; GREEDY940-NEXT:    s_nop 7
; GREEDY940-NEXT:    s_nop 7
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a31, a61
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a30, a60
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a29, a59
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a28, a58
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a27, a57
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a26, a56
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a25, a55
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a24, a54
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a23, a53
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a22, a52
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a21, a51
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a20, a50
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a19, a49
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a18, a48
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a17, a47
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a16, a46
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a15, a45
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a14, a44
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a13, a43
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a12, a42
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a11, a41
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a10, a40
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a9, a39
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a8, a38
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a7, a37
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a6, a36
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a5, a35
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a4, a34
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a3, a33
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a2, a32
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    v_mfma_f32_32x32x1_2b_f32 a[0:31], v0, v1, a[0:31]
; GREEDY940-NEXT:    s_nop 7
; GREEDY940-NEXT:    s_nop 7
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[24:27], s[34:35] offset:96 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[28:31], s[34:35] offset:112 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[16:19], s[34:35] offset:64 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[20:23], s[34:35] offset:80 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[8:11], s[34:35] offset:32 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[12:15], s[34:35] offset:48 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[0:3], s[34:35] sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[4:7], s[34:35] offset:16 sc0 sc1
; GREEDY940-NEXT:    s_endpgm
;
; GREEDY90A-GISEL-LABEL: test_mfma_f32_32x32x1f32:
; GREEDY90A-GISEL:       ; %bb.0: ; %bb
; GREEDY90A-GISEL-NEXT:    s_load_dwordx2 s[34:35], s[0:1], 0x24
...
; FAST:       ; %bb.0: ; %bb
; FAST-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    v_accvgpr_write_b32 a64, s36
; FAST-NEXT:    v_accvgpr_write_b32 a65, s37
; FAST-NEXT:    v_accvgpr_write_b32 a66, s38
; FAST-NEXT:    v_accvgpr_write_b32 a67, s39
; FAST-NEXT:    v_accvgpr_write_b32 a68, s40
; FAST-NEXT:    v_accvgpr_write_b32 a69, s41
; FAST-NEXT:    v_accvgpr_write_b32 a70, s42
; FAST-NEXT:    v_accvgpr_write_b32 a71, s43
; FAST-NEXT:    v_accvgpr_write_b32 a72, s44
; FAST-NEXT:    v_accvgpr_write_b32 a73, s45
; FAST-NEXT:    v_accvgpr_write_b32 a74, s46
; FAST-NEXT:    v_accvgpr_write_b32 a75, s47
; FAST-NEXT:    v_accvgpr_write_b32 a76, s48
; FAST-NEXT:    v_accvgpr_write_b32 a77, s49
; FAST-NEXT:    v_accvgpr_write_b32 a78, s50
; FAST-NEXT:    v_accvgpr_write_b32 a79, s51
; FAST-NEXT:    v_accvgpr_write_b32 a80, s4
; FAST-NEXT:    v_accvgpr_write_b32 a81, s5
; FAST-NEXT:    v_accvgpr_write_b32 a82, s6
; FAST-NEXT:    v_accvgpr_write_b32 a83, s7
; FAST-NEXT:    v_accvgpr_write_b32 a84, s8
; FAST-NEXT:    v_accvgpr_write_b32 a85, s9
; FAST-NEXT:    v_accvgpr_write_b32 a86, s10
; FAST-NEXT:    v_accvgpr_write_b32 a87, s11
; FAST-NEXT:    v_accvgpr_write_b32 a88, s12
; FAST-NEXT:    v_accvgpr_write_b32 a89, s13
; FAST-NEXT:    v_accvgpr_write_b32 a90, s14
; FAST-NEXT:    v_accvgpr_write_b32 a91, s15
; FAST-NEXT:    v_accvgpr_write_b32 a92, s16
; FAST-NEXT:    v_accvgpr_write_b32 a93, s17
; FAST-NEXT:    v_accvgpr_write_b32 a94, s18
; FAST-NEXT:    v_accvgpr_write_b32 a95, s19
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[64:95], v1, v2, a[64:95]
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v1, v2, a[64:95]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_accvgpr_mov_b32 a1, a65
; FAST-NEXT:    v_accvgpr_mov_b32 a0, a64
...
; GREEDY908:       ; %bb.0: ; %bb
; GREEDY908-NEXT:    s_load_dwordx2 s[16:17], s[0:1], 0x24
...
; GREEDY90A:       ; %bb.0: ; %bb
; GREEDY90A-NEXT:    s_load_dwordx2 s[16:17], s[0:1], 0x24
...
; GREEDY90A-NEXT:    s_endpgm
;
; GREEDY940-LABEL: test_mfma_f32_16x16x1f32:
; GREEDY940:       ; %bb.0: ; %bb
; GREEDY940-NEXT:    s_load_dwordx2 s[16:17], s[0:1], 0x24
; GREEDY940-NEXT:    v_mov_b32_e32 v16, 1.0
; GREEDY940-NEXT:    v_mov_b32_e32 v17, 2.0
; GREEDY940-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY940-NEXT:    s_load_dwordx16 s[0:15], s[16:17], 0x0
; GREEDY940-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY940-NEXT:    v_accvgpr_write_b32 a31, s15
; GREEDY940-NEXT:    v_accvgpr_write_b32 a30, s14
; GREEDY940-NEXT:    v_accvgpr_write_b32 a29, s13
...
; GREEDY940-NEXT:    v_accvgpr_write_b32 a16, s0
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    v_mfma_f32_16x16x1_4b_f32 a[16:31], v16, v17, a[16:31]
; GREEDY940-NEXT:    v_mfma_f32_16x16x1_4b_f32 a[0:15], v16, v17, a[16:31]
; GREEDY940-NEXT:    s_nop 7
; GREEDY940-NEXT:    s_nop 0
; GREEDY940-NEXT:    v_accvgpr_read_b32 v0, a16
; GREEDY940-NEXT:    v_accvgpr_read_b32 v1, a17
; GREEDY940-NEXT:    v_accvgpr_read_b32 v15, a13
; GREEDY940-NEXT:    v_accvgpr_read_b32 v14, a12
; GREEDY940-NEXT:    v_accvgpr_read_b32 v13, a11
; GREEDY940-NEXT:    v_accvgpr_read_b32 v12, a10
; GREEDY940-NEXT:    v_accvgpr_read_b32 v11, a9
; GREEDY940-NEXT:    v_accvgpr_read_b32 v10, a8
; GREEDY940-NEXT:    v_accvgpr_read_b32 v9, a7
; GREEDY940-NEXT:    v_accvgpr_read_b32 v8, a6
; GREEDY940-NEXT:    v_accvgpr_read_b32 v7, a5
; GREEDY940-NEXT:    v_accvgpr_read_b32 v6, a4
; GREEDY940-NEXT:    v_accvgpr_read_b32 v5, a3
; GREEDY940-NEXT:    v_accvgpr_read_b32 v4, a2
; GREEDY940-NEXT:    v_accvgpr_read_b32 v3, a1
; GREEDY940-NEXT:    v_accvgpr_read_b32 v2, a0
; GREEDY940-NEXT:    v_accvgpr_write_b32 a0, v0
; GREEDY940-NEXT:    v_accvgpr_write_b32 a1, v1
; GREEDY940-NEXT:    v_accvgpr_write_b32 a2, v2
; GREEDY940-NEXT:    v_accvgpr_write_b32 a3, v3
; GREEDY940-NEXT:    v_accvgpr_write_b32 a4, v4
; GREEDY940-NEXT:    v_accvgpr_write_b32 a5, v5
; GREEDY940-NEXT:    v_accvgpr_write_b32 a6, v6
; GREEDY940-NEXT:    v_accvgpr_write_b32 a7, v7
; GREEDY940-NEXT:    v_accvgpr_write_b32 a8, v8
; GREEDY940-NEXT:    v_accvgpr_write_b32 a9, v9
; GREEDY940-NEXT:    v_accvgpr_write_b32 a10, v10
; GREEDY940-NEXT:    v_accvgpr_write_b32 a11, v11
; GREEDY940-NEXT:    v_accvgpr_write_b32 a12, v12
; GREEDY940-NEXT:    v_accvgpr_write_b32 a13, v13
; GREEDY940-NEXT:    v_accvgpr_write_b32 a14, v14
; GREEDY940-NEXT:    v_accvgpr_write_b32 a15, v15
; GREEDY940-NEXT:    v_mov_b32_e32 v0, 0
; GREEDY940-NEXT:    s_nop 0
; GREEDY940-NEXT:    v_mfma_f32_16x16x1_4b_f32 a[0:15], v16, v17, a[0:15]
; GREEDY940-NEXT:    s_nop 7
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    global_store_dwordx4 v0, a[12:15], s[16:17] offset:48 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v0, a[8:11], s[16:17] offset:32 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v0, a[4:7], s[16:17] offset:16 sc0 sc1
; GREEDY940-NEXT:    global_store_dwordx4 v0, a[0:3], s[16:17] sc0 sc1
; GREEDY940-NEXT:    s_endpgm
;
; GREEDY90A-GISEL-LABEL: test_mfma_f32_16x16x1f32:
; GREEDY90A-GISEL:       ; %bb.0: ; %bb
; GREEDY90A-GISEL-NEXT:    s_load_dwordx2 s[16:17], s[0:1], 0x24
; GREEDY90A-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GREEDY90A-GISEL-NEXT:    v_mov_b32_e32 v1, 2.0
; GREEDY90A-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    v_accvgpr_write_b32 a47, s19
; FAST-NEXT:    v_accvgpr_write_b32 a46, s18
; FAST-NEXT:    v_accvgpr_write_b32 a45, s17
; FAST-NEXT:    v_accvgpr_write_b32 a44, s16
; FAST-NEXT:    v_accvgpr_write_b32 a43, s15
; FAST-NEXT:    v_accvgpr_write_b32 a42, s14
; FAST-NEXT:    v_accvgpr_write_b32 a41, s13
; FAST-NEXT:    v_accvgpr_write_b32 a40, s12
; FAST-NEXT:    v_accvgpr_write_b32 a39, s11
; FAST-NEXT:    v_accvgpr_write_b32 a38, s10
; FAST-NEXT:    v_accvgpr_write_b32 a37, s9
; FAST-NEXT:    v_accvgpr_write_b32 a36, s8
; FAST-NEXT:    v_accvgpr_write_b32 a35, s7
; FAST-NEXT:    v_accvgpr_write_b32 a34, s6
; FAST-NEXT:    v_accvgpr_write_b32 a33, s5
; FAST-NEXT:    v_accvgpr_write_b32 a32, s4
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_16x16x1f32 a[32:47], v0, v1, a[32:47]
; FAST-NEXT:    v_mfma_f32_16x16x1f32 a[16:31], v0, v1, a[32:47]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 1
...
; GREEDY908:       ; %bb.0: ; %bb
; GREEDY908-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x24
; GREEDY908-NEXT:    v_mov_b32_e32 v0, 1.0
; GREEDY908-NEXT:    v_mov_b32_e32 v1, 2.0
; GREEDY908-NEXT:    v_mov_b32_e32 v4, 0
; GREEDY908-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY908-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GREEDY908-NEXT:    s_waitcnt lgkmcnt(0)
...
; GREEDY908-NEXT:    v_mfma_f32_4x4x1f32 a[4:7], v0, v1, a[0:3]
; GREEDY908-NEXT:    s_nop 3
; GREEDY908-NEXT:    v_accvgpr_read_b32 v5, a5
; GREEDY908-NEXT:    v_accvgpr_read_b32 v3, a4
; GREEDY908-NEXT:    s_nop 0
; GREEDY908-NEXT:    v_accvgpr_write_b32 a3, v5
; GREEDY908-NEXT:    v_accvgpr_write_b32 a2, v3
; GREEDY908-NEXT:    s_nop 0
...
; GREEDY908-NEXT:    v_accvgpr_read_b32 v3, a3
; GREEDY908-NEXT:    s_nop 1
; GREEDY908-NEXT:    global_store_dwordx4 v4, v[0:3], s[4:5]
; GREEDY908-NEXT:    s_endpgm
;
; GREEDY90A-LABEL: test_mfma_f32_4x4x1f32:
; GREEDY90A:       ; %bb.0: ; %bb
; GREEDY90A-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x24
; GREEDY90A-NEXT:    v_mov_b32_e32 v0, 1.0
; GREEDY90A-NEXT:    v_mov_b32_e32 v1, 2.0
; GREEDY90A-NEXT:    v_mov_b32_e32 v2, 0
; GREEDY90A-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY90A-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GREEDY90A-NEXT:    s_waitcnt lgkmcnt(0)
...
; GREEDY90A-NEXT:    v_mfma_f32_4x4x1f32 a[4:7], v0, v1, a[0:3]
; GREEDY90A-NEXT:    s_nop 4
; GREEDY90A-NEXT:    v_accvgpr_mov_b32 a3, a5
; GREEDY90A-NEXT:    v_accvgpr_mov_b32 a2, a4
; GREEDY90A-NEXT:    s_nop 1
; GREEDY90A-NEXT:    v_mfma_f32_4x4x1f32 a[0:3], v0, v1, a[0:3]
; GREEDY90A-NEXT:    s_nop 4
; GREEDY90A-NEXT:    global_store_dwordx4 v2, a[0:3], s[4:5]
; GREEDY90A-NEXT:    s_endpgm
;
; GREEDY940-LABEL: test_mfma_f32_4x4x1f32:
; GREEDY940:       ; %bb.0: ; %bb
; GREEDY940-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x24
; GREEDY940-NEXT:    v_mov_b32_e32 v0, 1.0
; GREEDY940-NEXT:    v_mov_b32_e32 v1, 2.0
; GREEDY940-NEXT:    v_mov_b32_e32 v2, 0
; GREEDY940-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY940-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GREEDY940-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY940-NEXT:    v_accvgpr_write_b32 a0, s0
; GREEDY940-NEXT:    v_accvgpr_write_b32 a1, s1
; GREEDY940-NEXT:    v_accvgpr_write_b32 a2, s2
; GREEDY940-NEXT:    v_accvgpr_write_b32 a3, s3
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    v_mfma_f32_4x4x1_16b_f32 a[0:3], v0, v1, a[0:3]
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    v_mfma_f32_4x4x1_16b_f32 a[4:7], v0, v1, a[0:3]
; GREEDY940-NEXT:    s_nop 3
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a3, a5
; GREEDY940-NEXT:    v_accvgpr_mov_b32 a2, a4
; GREEDY940-NEXT:    s_nop 1
; GREEDY940-NEXT:    v_mfma_f32_4x4x1_16b_f32 a[0:3], v0, v1, a[0:3]
; GREEDY940-NEXT:    s_nop 3
; GREEDY940-NEXT:    global_store_dwordx4 v2, a[0:3], s[4:5] sc0 sc1
; GREEDY940-NEXT:    s_endpgm
;
; GREEDY90A-GISEL-LABEL: test_mfma_f32_4x4x1f32:
; GREEDY90A-GISEL:       ; %bb.0: ; %bb
; GREEDY90A-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x24
; GREEDY90A-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GREEDY90A-GISEL-NEXT:    v_mov_b32_e32 v1, 2.0
; GREEDY90A-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY90A-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GREEDY90A-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GREEDY90A-GISEL-NEXT:    v_accvgpr_write_b32 a0, s0
; GREEDY90A-GISEL-NEXT:    v_accvgpr_write_b32 a1, s1
; GREEDY90A-GISEL-NEXT:    v_accvgpr_write_b32 a2, s2
...
; GREEDY90A-GISEL-NEXT:    v_mfma_f32_4x4x1f32 a[4:7], v0, v1, a[0:3]
; GREEDY90A-GISEL-NEXT:    s_nop 4
; GREEDY90A-GISEL-NEXT:    v_accvgpr_mov_b32 a2, a4
; GREEDY90A-GISEL-NEXT:    v_accvgpr_mov_b32 a3, a5
; GREEDY90A-GISEL-NEXT:    s_nop 1
; GREEDY90A-GISEL-NEXT:    v_mfma_f32_4x4x1f32 a[0:3], v0, v1, a[0:3]
; GREEDY90A-GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GREEDY90A-GISEL-NEXT:    s_nop 3
; GREEDY90A-GISEL-NEXT:    global_store_dwordx4 v0, a[0:3], s[4:5]
; GREEDY90A-GISEL-NEXT:    s_endpgm
;
...
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    v_accvgpr_write_b32 a11, s7
; FAST-NEXT:    v_accvgpr_write_b32 a10, s6
; FAST-NEXT:    v_accvgpr_write_b32 a9, s5
; FAST-NEXT:    v_accvgpr_write_b32 a8, s4
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_4x4x1f32 a[8:11], v1, v2, a[8:11]
; FAST-NEXT:    v_mfma_f32_4x4x1f32 a[4:7], v1, v2, a[8:11]
; FAST-NEXT:    s_nop 3
; FAST-NEXT:    v_accvgpr_mov_b32 a1, a9
; FAST-NEXT:    v_accvgpr_mov_b32 a0, a8
