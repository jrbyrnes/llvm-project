...
; CI-NEXT:    s_add_u32 s2, s0, 16
; CI-NEXT:    s_addc_u32 s3, s1, 0
; CI-NEXT:    v_mov_b32_e32 v23, s3
; CI-NEXT:    v_mov_b32_e32 v22, s2
; CI-NEXT:    s_add_u32 s2, s0, 48
; CI-NEXT:    v_mov_b32_e32 v21, s1
; CI-NEXT:    s_addc_u32 s3, s1, 0
; CI-NEXT:    v_mov_b32_e32 v20, s0
; CI-NEXT:    s_add_u32 s0, s0, 32
; CI-NEXT:    s_addc_u32 s1, s1, 0
; CI-NEXT:    v_mov_b32_e32 v25, s3
; CI-NEXT:    v_mov_b32_e32 v27, s1
; CI-NEXT:    v_mov_b32_e32 v24, s2
; CI-NEXT:    v_mov_b32_e32 v26, s0
...
; CI-NEXT:    v_cvt_f32_f16_e32 v19, v7
; CI-NEXT:    v_cvt_f32_f16_e32 v17, v6
...
; CI-NEXT:    flat_store_dwordx4 v[22:23], v[16:19]
; CI-NEXT:    flat_store_dwordx4 v[20:21], v[0:3]
; CI-NEXT:    flat_store_dwordx4 v[24:25], v[12:15]
; CI-NEXT:    flat_store_dwordx4 v[26:27], v[8:11]
; CI-NEXT:    s_endpgm
;
...
; CI-NEXT:    s_addc_u32 s3, s1, 0
; CI-NEXT:    v_mov_b32_e32 v22, s3
; CI-NEXT:    v_mov_b32_e32 v21, s2
...
; CI-NEXT:    v_cvt_f32_f16_e32 v17, v3
...
; CI-NEXT:    v_cvt_f32_f16_e32 v23, v5
; CI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v7
; CI-NEXT:    flat_store_dwordx4 v[11:12], v[0:3]
; CI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v10
; CI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v6
; CI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v13
; CI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v16
; CI-NEXT:    v_cvt_f64_f32_e32 v[12:13], v17
; CI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v18
; CI-NEXT:    flat_store_dwordx4 v[19:20], v[6:9]
; CI-NEXT:    v_mov_b32_e32 v14, s2
; CI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v23
; CI-NEXT:    v_mov_b32_e32 v9, s1
; CI-NEXT:    v_mov_b32_e32 v8, s0
; CI-NEXT:    flat_store_dwordx4 v[21:22], v[10:13]
...
; VI-NEXT:    s_addc_u32 s1, s1, 0
; VI-NEXT:    v_mov_b32_e32 v24, s3
; VI-NEXT:    v_mov_b32_e32 v23, s2
; VI-NEXT:    s_waitcnt vmcnt(1)
...
; VI-NEXT:    v_cvt_f32_f16_e32 v13, v0
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v7
; VI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v8
; VI-NEXT:    v_cvt_f32_f16_sdwa v14, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
...
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v7
; VI-NEXT:    v_cvt_f32_f16_sdwa v16, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
...
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v8
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v9
; VI-NEXT:    v_cvt_f32_f16_e32 v8, v1
; VI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v10
; VI-NEXT:    flat_store_dwordx4 v[11:12], v[2:5]
; VI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v8
; VI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v15
; VI-NEXT:    v_cvt_f64_f32_e32 v[12:13], v13
; VI-NEXT:    v_cvt_f64_f32_e32 v[14:15], v14
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v6
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v7
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v16
; VI-NEXT:    flat_store_dwordx4 v[19:20], v[8:11]
; VI-NEXT:    s_nop 0
; VI-NEXT:    v_mov_b32_e32 v9, s1
; VI-NEXT:    v_mov_b32_e32 v8, s0
; VI-NEXT:    flat_store_dwordx4 v[21:22], v[12:15]
; VI-NEXT:    flat_store_dwordx4 v[23:24], v[4:7]
; VI-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; VI-NEXT:    s_endpgm
;
