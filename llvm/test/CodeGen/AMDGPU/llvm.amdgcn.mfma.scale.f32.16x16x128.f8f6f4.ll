...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mov_b32_e32 v20, s1
; SDAG-NEXT:    s_nop 1
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[8:15], v[16:19], v20, s0 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[12:19], v[4:11], v[20:23], v2, v3 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[14:21], v[0:7], v[8:11], s20, v12 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    v_mov_b32_e32 v21, s19
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[14:21], v[0:7], v[8:11], v12, s20 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    v_mov_b32_e32 v21, s19
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[14:21], v[8:11], v12, s20 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[8:15], v[18:21], v16, s16 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[10:17], v[0:7], v[18:21], v8, s24 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[8:15], v[16:19], 33, -2 op_sel_hi:[1,1,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL-NEXT:    v_accvgpr_write_b32 a3, v19
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], 33, -2 op_sel_hi:[1,1,0]
; GISEL-NEXT:    s_nop 7
; GISEL-NEXT:    s_nop 3
; GISEL-NEXT:    v_accvgpr_read_b32 v0, a0
; GISEL-NEXT:    v_accvgpr_read_b32 v1, a1
...
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[8:15], v[16:19], s0, -2 op_sel_hi:[1,1,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[8:15], v[16:19], s0, v20 op_sel_hi:[1,1,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[8:15], v[16:19], 0, 1 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[0:7], v[8:15], v[16:19], 1, 0 op_sel_hi:[0,0,0]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
