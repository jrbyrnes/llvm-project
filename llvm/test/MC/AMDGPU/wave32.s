...
v_div_scale_f32 v2, vcc_lo, v0, v0, v2
// GFX1032: v_div_scale_f32 v2, vcc_lo, v0, v0, v2 ; encoding: [0x02,0x6a,0x6d,0xd5,0x00,0x01,0x0a,0x04]
// GFX1064-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_div_scale_f32 v2, vcc, v0, v0, v2
// GFX1032-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX1064: v_div_scale_f32 v2, vcc, v0, v0, v2 ; encoding: [0x02,0x6a,0x6d,0xd5,0x00,0x01,0x0a,0x04]

v_div_scale_f64 v[2:3], vcc_lo, v[0:1], v[0:1], v[2:3]
// GFX1032: v_div_scale_f64 v[2:3], vcc_lo, v[0:1], v[0:1], v[2:3] ; encoding: [0x02,0x6a,0x6e,0xd5,0x00,0x01,0x0a,0x04]
// GFX1064-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_div_scale_f64 v[2:3], vcc, v[0:1], v[0:1], v[2:3]
// GFX1032-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX1064: v_div_scale_f64 v[2:3], vcc, v[0:1], v[0:1], v[2:3] ; encoding: [0x02,0x6a,0x6e,0xd5,0x00,0x01,0x0a,0x04]
