...
;.
; CHECK: attributes #[[ATTR0:[0-9]+]] = { sanitize_memory }
; CHECK: attributes #[[ATTR1:[0-9]+]] = { nocallback nofree nosync nounwind willreturn memory(none) }
; CHECK: attributes #[[ATTR2:[0-9]+]] = { nocallback nofree nosync nounwind willreturn memory(read) }
...
; CHECK: attributes #[[ATTR5:[0-9]+]] = { nounwind }
; CHECK: attributes #[[ATTR6:[0-9]+]] = { nounwind sanitize_memory }
