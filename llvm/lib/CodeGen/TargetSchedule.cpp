...
bool TargetSchedModel::hasInstrSchedModel() const {
  return EnableSchedModel && SchedModel.hasInstrSchedModel() && !DisableItinerariesAndSchedModel;
}

bool TargetSchedModel::hasInstrItineraries() const {
  return EnableSchedItins && !InstrItins.isEmpty() && !DisableItinerariesAndSchedModel;
}
