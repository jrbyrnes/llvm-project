...
private:
  ...
  /// Check if an instruction \p I is immediately after another control instruction
  /// which it cannot coissue with. If so, insert before that instruction to encourage
  /// more coissuing.
  MachineBasicBlock::instr_iterator
