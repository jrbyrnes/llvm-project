...
// Tracks the number of cycles that a resource is occupied. Requires top-downAdd commentMore actions
// scheduling.
struct ProcRes {
...
protected:
  ...
  // otherwise, try not to stall XDL.Add commentMore actions
