...
public:
  ...
  /// Allow the target to choose local assignment priorities instead of global.
  virtual bool preferLocalAssignment(const MachineFunction *MF, LiveIntervals *LIS) const { return false; }
